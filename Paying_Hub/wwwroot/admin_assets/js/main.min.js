!function(t, e) {
    ...
    C.extend = C.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = s[e],
                    s !== (n = t[e]) && (c && n && (C.isPlainObject(n) || (r = C.isArray(n))) ? (o = r ? (r = !1,
                    i && C.isArray(i) ? i : []) : i && C.isPlainObject(i) ? i : {},
                    s[e] = C.extend(c, o, n)) : void 0 !== n && (s[e] = n));
        return s
    }
    ,
    C.extend({
        ...
        isPlainObject: function(t) {
            return "object" === C.type(t) && !t.nodeType && !C.isWindow(t) && !(t.constructor && !m.call(t.constructor.prototype, "isPrototypeOf"))
        },
        ...
        globalEval: function(t) {
            var e, i = eval;
            (t = C.trim(t)) && (1 === t.indexOf("use strict") ? ((e = w.createElement("script")).text = t,
            w.head.appendChild(e).parentNode.removeChild(e)) : i(t))
        },
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = i),
            C.isFunction(t) ? (n = h.call(arguments, 2),
            (r = function() {
    ...
    var f = function(i) {
        ...
        var t, p, _, o, r, g, d, m, b, c, h, v, x, s, w, y, a, f, C, k = "sizzle" + 1 * new Date, E = i.document, T = 0, S = 0, l = ot(), L = ot(), I = ot(), D = function(t, e) {
            return t === e && (h = !0),
            0
        }, A = {}.hasOwnProperty, e = [], N = e.pop, $ = e.push, M = e.push, O = e.slice, H = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", B = "[\\x20\\t\\r\\n\\f]", j = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", z = j.replace("w", "w#"), W = "\\[" + B + "*(" + j + ")(?:" + B + "*([*^$|!~]?=)" + B + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + z + "))|)" + B + "*\\]", R = ":(" + j + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", F = new RegExp(B + "+","g"), q = new RegExp("^" + B + "+|((?:^|[^\\\\])(?:\\\\.)*)" + B + "+$","g"), Y = new RegExp("^" + B + "*," + B + "*"), X = new RegExp("^" + B + "*([>+~]|" + B + ")" + B + "*"), V = new RegExp("=" + B + "*([^\\]'\"]*?)" + B + "*\\]","g"), U = new RegExp(R), Z = new RegExp("^" + z + "$"), Q = {
            ID: new RegExp("^#(" + j + ")"),
            CLASS: new RegExp("^\\.(" + j + ")"),
        ...
        }, K = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, tt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, et = /[+~]/, it = /'|\\/g, nt = new RegExp("\\\\([\\da-f]{1,6}" + B + "?|(" + B + ")|.)","ig");
        try {
            M.apply(e = O.call(E.childNodes), E.childNodes),
        ...
        function rt(t, e, i, n) {
            ...
            if ((e ? e.ownerDocument || e : E) !== x && v(e),
            i = i || [],
            a = (e = e || x).nodeType,
            ...
            if (!n && w) {
                ...
                if (p.qsa && (!y || !y.test(t))) {
                    ...
                    1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (c = g(t),
                        (h = e.getAttribute("id")) ? u = h.replace(it, "\\$&") : e.setAttribute("id", u),
                        u = "[id='" + u + "'] ",
                        l = c.length; l--; )
                            c[l] = u + gt(c[l]);
                        d = et.test(t) && ft(e.parentNode) || e,
                        f = c.join(",")
                    }
                    if (f)
                        try {
                            return M.apply(i, d.querySelectorAll(f)),
                            i
                        } catch (t) {} finally {
        ...
        ,
        v = rt.setDocument = function(t) {
            var e, i, l = t ? t.ownerDocument || t : E;
            return l !== x && 9 === l.nodeType && l.documentElement ? (s = (x = l).documentElement,
            (i = l.defaultView) && i !== i.top && (i.addEventListener ? i.addEventListener("unload", n, !1) : i.attachEvent && i.attachEvent("onunload", n)),
            w = !r(l),
            ...
            _.find.CLASS = p.getElementsByClassName && function(t, e) {
                return w ? e.getElementsByClassName(t) : void 0
            }
            ,
            a = [],
            y = [],
            (p.qsa = J.test(l.querySelectorAll)) && (at(function(t) {
                s.appendChild(t).innerHTML = "<a id='" + k + "'></a><select id='" + k + "-\f]' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && y.push("[*^$]=" + B + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || y.push("\\[" + B + "*(?:value|" + P + ")"),
                t.querySelectorAll("[id~=" + k + "-]").length || y.push("~="),
                t.querySelectorAll(":checked").length || y.push(":checked"),
                t.querySelectorAll("a#" + k + "+*").length || y.push(".#.+[+~]")
            }),
            at(function(t) {
                var e = l.createElement("input");
                e.setAttribute("type", "hidden"),
                t.appendChild(e).setAttribute("name", "D"),
                t.querySelectorAll("[name=d]").length && y.push("name" + B + "*[*^$|!~]?="),
                t.querySelectorAll(":enabled").length || y.push(":enabled", ":disabled"),
                t.querySelectorAll("*,:x"),
                y.push(",.*:")
            })),
            (p.matchesSelector = J.test(f = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && at(function(t) {
                p.disconnectedMatch = f.call(t, "div"),
                f.call(t, "[s!='']:x"),
                a.push("!=", R)
            }),
            ...
            C = e || J.test(s.contains) ? function(t, e) {
            ...
            D = e ? function(t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !p.sortDetached && e.compareDocumentPosition(t) === i ? t === l || t.ownerDocument === E && C(E, t) ? -1 : e === l || e.ownerDocument === E && C(E, e) ? 1 : c ? H(c, t) - H(c, e) : 0 : 4 & i ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return h = !0,
                ...
                if (!r || !o)
                    return t === l ? -1 : e === l ? 1 : r ? -1 : o ? 1 : c ? H(c, t) - H(c, e) : 0;
                if (r === o)
                    return ct(t, e);
        ...
        rt.matchesSelector = function(t, e) {
            if ((t.ownerDocument || t) !== x && v(t),
            e = e.replace(V, "='$1']"),
            !(!p.matchesSelector || !w || a && a.test(e) || y && y.test(e)))
                try {
                    var i = f.call(t, e);
        ...
        rt.contains = function(t, e) {
            return (t.ownerDocument || t) !== x && v(t),
            C(t, e)
        }
        ,
        rt.attr = function(t, e) {
            ...
            var i = _.attrHandle[e.toLowerCase()]
              , n = i && A.call(_.attrHandle, e.toLowerCase()) ? i(t, e, !w) : void 0;
            return void 0 !== n ? n : p.attributes || !w ? t.getAttribute(e) : (n = t.getAttributeNode(e)) && n.specified ? n.value : null
        }
        ,
        rt.error = function(t) {
        ...
        (_ = rt.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return Q.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && U.test(i) && (e = g(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(f, t, e, p, g) {
                    var m = "nth" !== f.slice(0, 3)
                      , v = "last" !== f.slice(-4)
                      , w = "of-type" === t;
                    return 1 === p && 0 === g ? function(t) {
                        return !!t.parentNode
                    }
                    : function(t, e, i) {
                        var n, r, o, s, a, l, c = m != v ? "nextSibling" : "previousSibling", h = t.parentNode, u = w && t.nodeName.toLowerCase(), d = !i && !w;
                        if (h) {
                            if (m) {
                                for (; c; ) {
                                    for (o = t; o = o[c]; )
                                        if (w ? o.nodeName.toLowerCase() === u : 1 === o.nodeType)
                                            return !1;
                            ...
                            v && d) {
                                for (a = (n = (r = h[k] || (h[k] = {}))[f] || [])[0] === T && n[1],
                                s = n[0] === T && n[2],
                                o = a && h.childNodes[a]; o = ++a && o && o[c] || (s = a = 0) || l.pop(); )
                                    if (1 === o.nodeType && ++s && o === t) {
                                        r[f] = [T, a, s];
                                        break
                                    }
                            } else if (d && (n = (t[k] || (t[k] = {}))[f]) && n[0] === T)
                                s = n[1];
                            else
                                for (; (o = ++a && o && o[c] || (s = a = 0) || l.pop()) && ((w ? o.nodeName.toLowerCase() !== u : 1 !== o.nodeType) || !++s || (d && ((o[k] || (o[k] = {}))[f] = [T, s]),
                                o !== t)); )
                                    ;
                ...
                PSEUDO: function(t, o) {
                    ...
                    _.setFilters.hasOwnProperty(t.toLowerCase()) ? st(function(t, e) {
            ...
            pseudos: {
                not: st(function(t) {
                    var n = []
                      , r = []
                      , a = d(t.replace(q, "$1"));
                    return a[k] ? st(function(t, e, i, n) {
                ...
                lang: st(function(i) {
                    return Z.test(i || "") || rt.error("unsupported lang: " + i),
                    i = i.replace(nt, u).toLowerCase(),
                    function(t) {
                        var e;
                        do {
                            if (e = w ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang"))
        ...
        function mt(s, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    for (; t = t[a]; )
                        if ((1 === t.nodeType || l) && s(t, e, i))
                            return !0
                } else
                    for (; t = t[a]; )
                        if (1 === t.nodeType || l) {
                            if ((n = (r = t[k] || (t[k] = {}))[a]) && n[0] === T && n[1] === c)
                                return o[2] = n[2];
                            if ((r[a] = o)[2] = s(t, e, i))
                                return !0
                        }
        ...
        function yt(f, p, g, m, v, t) {
            return m && !m[k] && (m = yt(m)),
            v && !v[k] && (v = yt(v, t)),
            st(function(t, e, i, n) {
                var r, o, s, a = [], l = [], c = e.length, h = t || function(t, e, i) {
                    for (var n = 0, r = e.length; n < r; n++)
                        rt(t, e[n], i);
                    return i
                }(p || "*", i.nodeType ? [i] : i, []), u = !f || !t && p ? h : wt(h, a, f, i, n), d = g ? v || (t ? f : c || m) ? [] : e : u;
                if (g && g(u, d, i, n),
                m)
                    for (r = wt(d, l),
                    m(r, [], i, n),
                ...
                if (t) {
                    if (v || f) {
                        ...
                        for (o = d.length; o--; )
                            (s = d[o]) && -1 < (r = v ? H(t, s) : a[o]) && (t[r] = !(e[r] = s))
                    }
                } else
                    d = wt(d === e ? d.splice(c, d.length) : d),
                    v ? v(null, e, d, n) : M.apply(e, d)
            })
        }
        function _t(t) {
            for (var r, e, i, n = t.length, o = _.relative[t[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = mt(function(t) {
                return t === r
            }, s, !0), c = mt(function(t) {
                return -1 < H(r, t)
                ...
                if (e = _.relative[t[a].type])
                    ...
                    if ((e = _.filter[t[a].type].apply(null, t[a].matches))[k]) {
                        for (i = ++a; i < n && !_.relative[t[i].type]; i++)
                            ;
                        return yt(1 < a && vt(h), 1 < a && gt(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(q, "$1"), e, a < i && _t(t.slice(a, i)), i < n && _t(t = t.slice(i)), i < n && gt(t))
                    }
                    h.push(e)
                }
            return vt(h)
        }
        return pt.prototype = _.filters = _.pseudos,
        _.setFilters = new pt,
        g = rt.tokenize = function(t, e) {
            var i, n, r, o, s, a, l, c = L[t + " "];
            if (c)
                return e ? 0 : c.slice(0);
            for (s = t,
            a = [],
            l = _.preFilter; s; ) {
                for (o in i && !(n = Y.exec(s)) || (n && (s = s.slice(n[0].length) || s),
                a.push(r = [])),
                i = !1,
                (n = X.exec(s)) && (i = n.shift(),
                r.push({
                    value: i,
                    type: n[0].replace(q, " ")
                }),
                s = s.slice(i.length)),
                _.filter)
                    !(n = Q[o].exec(s)) || l[o] && !(n = l[o](n)) || (i = n.shift(),
                    r.push({
                        value: i,
                        type: o,
                        matches: n
            ...
            return e ? s.length : s ? rt.error(t) : L(t, a).slice(0)
        }
        ,
        d = rt.compile = function(t, e) {
            var i, n = [], r = [], o = I[t + " "];
            if (!o) {
                for (i = (e = e || g(t)).length; i--; )
                    (o = _t(e[i]))[k] ? n.push(o) : r.push(o);
                (o = I(t, function(m, v) {
                    function t(t, e, i, n, r) {
                        var o, s, a, l = 0, c = "0", h = t && [], u = [], d = b, f = t || y && _.find.TAG("*", r), p = T += null == d ? 1 : Math.random() || .1, g = f.length;
                        for (r && (b = e !== x && e); c !== g && null != (o = f[c]); c++) {
                            if (y && o) {
                                for (s = 0; a = m[s++]; )
                                    if (a(o, e, i)) {
                                        n.push(o);
                        ...
                        w && c !== l) {
                            ...
                            M.apply(n, u),
                            r && !t && 0 < u.length && 1 < l + v.length && rt.uniqueSort(n)
                        }
                        return r && (T = p,
                        b = d),
                        h
        ...
        m = rt.select = function(t, e, i, n) {
            var r, o, s, a, l, c = "function" == typeof t && t, h = !n && g(t = c.selector || t);
            if (i = i || [],
            1 === h.length) {
                if (2 < (o = h[0] = h[0].slice(0)).length && "ID" === (s = o[0]).type && p.getById && 9 === e.nodeType && w && _.relative[o[1].type]) {
                    if (!(e = (_.find.ID(s.matches[0].replace(nt, u), e) || [])[0]))
                        return i;
                    c && (e = e.parentNode),
                ...
                !_.relative[a = s.type]); )
                    if ((l = _.find[a]) && (n = l(s.matches[0].replace(nt, u), et.test(o[0].type) && ft(e.parentNode) || e))) {
                        if (o.splice(r, 1),
                        !(t = n.length && gt(o)))
                            return M.apply(i, n),
                            i;
            ...
            return (c || d(t, h))(n, e, !w, i, et.test(t) && ft(e.parentNode) || e),
            i
        }
        ,
    ...
    function x(t, i, n) {
        ...
        if ("string" == typeof i) {
            if (b.test(i))
                return C.filter(i, t, n);
            i = C.filter(i, t)
        }
        return C.grep(t, function(t) {
            return 0 <= r.call(i, t) !== n
        })
    }
    ...
    (C.fn.init = function(t, e) {
        ...
        if ("string" != typeof t)
            ...
            this.length = 1,
            this) : C.isFunction(t) ? void 0 !== k.ready ? k.ready(t) : t(C) : (void 0 !== t.selector && (this.selector = t.selector,
        ...
        if (i[1]) {
            ...
            C.merge(this, C.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : w, !0)),
            _.test(i[1]) && C.isPlainObject(e))
                for (i in e)
                    C.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this
        }
        return (n = w.getElementById(i[2])) && n.parentNode && (this.length = 1,
        this[0] = n),
        this.context = w,
        this.selector = t,
        this
    ...
    C.fn.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0, r = this.length, o = [], s = y.test(t) || "string" != typeof t ? C(t, e || this.context) : 0; n < r; n++)
    ...
    var I, D = /\S+/g, A = {};
    function N() {
        w.removeEventListener("DOMContentLoaded", N, !1),
        p.removeEventListener("load", N, !1),
        C.ready()
    }
    C.Callbacks = function(r) {
        r = "string" == typeof r ? A[r] || function(t) {
            var i = A[t] = {};
        ...
        var e, i, n, o, s, a, l = [], c = !r.once && [], h = function(t) {
            for (e = r.memory && t,
            i = !0,
            a = o || 0,
            o = 0,
            s = l.length,
            n = !0; l && a < s; a++)
                if (!1 === l[a].apply(t[0], t[1]) && r.stopOnFalse) {
                    e = !1;
                    break
                }
            n = !1,
            l && (c ? c.length && h(c.shift()) : e ? l = [] : u.disable())
        }, u = {
            add: function() {
                if (l) {
                    var t = l.length;
                    !function n(t) {
                        C.each(t, function(t, e) {
                            var i = C.type(e);
                            "function" === i ? r.unique && u.has(e) || l.push(e) : e && e.length && "string" !== i && n(e)
                        })
                    }(arguments),
                    n ? s = l.length : e && (o = t,
                    h(e))
            ...
            remove: function() {
                return l && C.each(arguments, function(t, e) {
            ...
            has: function(t) {
                return t ? -1 < C.inArray(t, l) : !(!l || !l.length)
            },
            empty: function() {
                return l = [],
                s = 0,
            ...
            fireWith: function(t, e) {
                return !l || i && !c || (e = [t, (e = e || []).slice ? e.slice() : e],
                n ? c.push(e) : h(e)),
                this
            },
            fire: function() {
        ...
        when: function(t) {
            function e(e, i, n) {
                return function(t) {
                    ...
                    n === r ? c.notifyWith(i, n) : --l || c.resolveWith(i, n)
                }
            }
            var r, i, n, o = 0, s = h.call(arguments), a = s.length, l = 1 !== a || t && C.isFunction(t.promise) ? a : 0, c = 1 === l ? t : C.Deferred();
            if (1 < a)
                for (r = new Array(a),
                i = new Array(a),
                n = new Array(a); o < a; o++)
                    s[o] && C.isFunction(s[o].promise) ? s[o].promise().done(e(o, n, s)).fail(c.reject).progress(e(o, i, r)) : --l;
    ...
    C.extend({
        ...
        ready: function(t) {
            (!0 === t ? --C.readyWait : C.isReady) || ((C.isReady = !0) !== t && 0 < --C.readyWait || (I.resolveWith(w, [C]),
            C.fn.triggerHandler && (C(w).triggerHandler("ready"),
            C(w).off("ready"))))
        }
    }),
    C.ready.promise = function(t) {
        return I || (I = C.Deferred(),
        "complete" === w.readyState ? setTimeout(C.ready) : (w.addEventListener("DOMContentLoaded", N, !1),
        p.addEventListener("load", N, !1))),
        I.promise(t)
    }
    ,
    C.ready.promise();
    var $ = C.access = function(t, e, i, n, r, o, s) {
        var a = 0
          , l = t.length
          , c = null == i;
        if ("object" === C.type(i))
    ...
    M.prototype = {
        ...
        access: function(t, e, i) {
            var n;
            return void 0 === e || e && "string" == typeof e && void 0 === i ? void 0 !== (n = this.get(t, e)) ? n : this.get(t, C.camelCase(e)) : (this.set(t, e, i),
            void 0 !== i ? i : e)
        },
        remove: function(t, e) {
            var i, n, r, o = this.key(t), s = this.cache[o];
            if (void 0 === e)
                this.cache[o] = {};
            else {
                i = (n = C.isArray(e) ? e.concat(e.map(C.camelCase)) : (r = C.camelCase(e),
                e in s ? [e, r] : (n = r)in s ? [n] : n.match(D) || [])).length;
                for (; i--; )
                    delete s[n[i]]
            }
        },
    ...
    function j(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(B, "-$1").toLowerCase(),
            "string" == typeof (i = t.getAttribute(n))) {
                try {
                    i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : P.test(i) ? C.parseJSON(i) : i)
                } catch (t) {}
                H.set(t, e, i)
            } else
                i = void 0;
    ...
    C.extend({
        hasData: function(t) {
            return H.hasData(t) || O.hasData(t)
        },
        data: function(t, e, i) {
        ...
        data: function(n, t) {
            ...
            if (void 0 !== n)
                return "object" == typeof n ? this.each(function() {
                    ...
                    if (o && void 0 === e) {
                        if (void 0 !== (t = H.get(o, n)))
                            return t;
                        if (void 0 !== (t = H.get(o, i)))
                            return t;
                        if (void 0 !== (t = j(o, i, void 0)))
                            return t
                    } else
                        this.each(function() {
                            var t = H.get(this, i);
                            H.set(this, i, e),
                            -1 !== n.indexOf("-") && void 0 !== t && H.set(this, n, e)
                        })
                }, null, t, 1 < arguments.length, null, !0);
            if (this.length && (r = H.get(o),
            1 === o.nodeType && !O.get(o, "hasDataAttrs"))) {
                for (e = s.length; e--; )
                    s[e] && (0 === (i = s[e].name).indexOf("data-") && (i = C.camelCase(i.slice(5)),
                    j(o, i, r[i])));
    ...
    C.extend({
        queue: function(t, e, i) {
            ...
            n = O.get(t, e),
            i && (!n || C.isArray(i) ? n = O.access(t, e, C.makeArray(i)) : n.push(i)),
            n || []) : void 0
        },
    ...
    C.fn.extend({
        ...
        promise: function(t, e) {
            ...
            var n, r = 1, o = C.Deferred(), s = this, a = this.length;
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; a--; )
                (n = O.get(s[a], t + "queueHooks")) && n.empty && (r++,
                n.empty.add(i));
            return i(),
            o.promise(e)
        }
    ...
    var W, R, F = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, q = ["Top", "Right", "Bottom", "Left"], Y = /^(?:checkbox|radio)$/i;
    W = w.createDocumentFragment().appendChild(w.createElement("div")),
    (R = w.createElement("input")).setAttribute("type", "radio"),
    R.setAttribute("checked", "checked"),
    R.setAttribute("name", "t"),
    W.appendChild(R),
    v.checkClone = W.cloneNode(!0).cloneNode(!0).lastChild.checked,
    W.innerHTML = "<textarea>x</textarea>",
    v.noCloneChecked = !!W.cloneNode(!0).lastChild.defaultValue;
    var X = "undefined";
    ...
    C.event = {
        ...
        add: function(e, t, i, n, r) {
            var o, s, a, l, c, h, u, d, f, p, g, m = O.get(e);
            if (m)
                ...
                (s = m.handle) || (s = m.handle = function(t) {
                    return typeof C != X && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0
                }
                ),
                c = (t = (t || "").match(D) || [""]).length; c--; )
                    ...
                    u.setup && !1 !== u.setup.call(e, n, p, s) || e.addEventListener && e.addEventListener(f, s, !1)),
        ...
        remove: function(t, e, i, n, r) {
            var o, s, a, l, c, h, u, d, f, p, g, m = O.hasData(t) && O.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(D) || [""]).length; c--; )
                    if (f = g = (a = Q.exec(e[c]) || [])[1],
                    p = (a[2] || "").split(".").sort(),
                    f) {
                        ...
                        s = o = d.length; o--; )
                            h = d[o],
                            !r && g !== h.origType || i && i.guid !== h.guid || a && !a.test(h.namespace) || n && n !== h.selector && ("**" !== n || !h.selector) || (d.splice(o, 1),
                            h.selector && d.delegateCount--,
                            u.remove && u.remove.call(t, h));
                        s && !d.length && (u.teardown && !1 !== u.teardown.call(t, p, m.handle) || C.removeEvent(t, f, m.handle),
                        delete l[f])
                    } else
                        for (f in l)
                            C.event.remove(t, f + e[c], i, n, !0);
                C.isEmptyObject(l) && (delete m.handle,
                O.remove(t, "events"))
            }
        },
        trigger: function(t, e, i, n) {
            var r, o, s, a, l, c, h, u = [i || w], d = m.call(t, "type") ? t.type : t, f = m.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = s = i = i || w,
            3 !== i.nodeType && 8 !== i.nodeType && !Z.test(d + C.event.triggered) && (0 <= d.indexOf(".") && (d = (f = d.split(".")).shift(),
            f.sort()),
            l = d.indexOf(":") < 0 && "on" + d,
            ...
            n || !h.trigger || !1 !== h.trigger.apply(i, e))) {
                if (!n && !h.noBubble && !C.isWindow(i)) {
                    for (a = h.delegateType || d,
                    Z.test(a + d) || (o = o.parentNode); o; o = o.parentNode)
                        u.push(o),
                        s = o;
                    s === (i.ownerDocument || w) && u.push(s.defaultView || s.parentWindow || p)
                }
                for (r = 0; (o = u[r++]) && !t.isPropagationStopped(); )
                    t.type = 1 < r ? a : h.bindType || d,
                    (c = (O.get(o, "events") || {})[t.type] && O.get(o, "handle")) && c.apply(o, e),
                    (c = l && o[l]) && c.apply && C.acceptData(o) && (t.result = c.apply(o, e),
                    !1 === t.result && t.preventDefault());
                return t.type = d,
                n || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(u.pop(), e) || !C.acceptData(i) || l && C.isFunction(i[d]) && !C.isWindow(i) && ((s = i[l]) && (i[l] = null),
        ...
        dispatch: function(t) {
            t = C.event.fix(t);
            var e, i, n, r, o, s = [], a = h.call(arguments), l = (O.get(this, "events") || {})[t.type] || [], c = C.event.special[t.type] || {};
            if ((a[0] = t).delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                for (s = C.event.handlers.call(this, t, l),
                e = 0; (r = s[e++]) && !t.isPropagationStopped(); )
                    ...
                    i = 0; (o = r.handlers[i++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = o.data,
                        void 0 !== (n = ((C.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)) && !1 === (t.result = n) && (t.preventDefault(),
                        t.stopPropagation()));
            ...
            if (a && l.nodeType && (!t.button || "click" !== t.type))
                for (; l !== this; l = l.parentNode || this)
                    if (!0 !== l.disabled || "click" !== t.type) {
                        for (n = [],
                        i = 0; i < a; i++)
                            void 0 === n[r = (o = e[i]).selector + " "] && (n[r] = o.needsContext ? 0 <= C(r, this).index(l) : C.find(r, this, null, [l]).length),
                            n[r] && n.push(o);
                        n.length && s.push({
                            elem: l,
                            handlers: n
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                return null == t.pageX && null != e.clientX && (n = (i = t.target.ownerDocument || w).documentElement,
                r = i.body,
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[r] = s = U.test(r) ? this.mouseHooks : V.test(r) ? this.keyHooks : {}),
            n = s.props ? this.props.concat(s.props) : this.props,
            t = new C.Event(o),
            e = n.length; e--; )
                t[i = n[e]] = o[i];
            return t.target || (t.target = w),
        ...
        simulate: function(t, e, i, n) {
            ...
            n ? C.event.trigger(r, null, e) : C.event.dispatch.call(e, r),
    ...
    C.Event = function(t, e) {
        return this instanceof C.Event ? (t && t.type ? (this.originalEvent = t,
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? K : G) : this.type = t,
        e && C.extend(this, e),
        this.timeStamp = t && t.timeStamp || C.now(),
        void (this[C.expando] = !0)) : new C.Event(t,e)
    }
    ,
    C.Event.prototype = {
    ...
    v.focusinBubbles || C.each({
        ...
        C.event.special[n] = {
            ...
            teardown: function() {
                var t = this.ownerDocument || this
                  , e = O.access(t, n) - 1;
                e ? O.access(t, n, e) : (t.removeEventListener(i, r, !0),
                O.remove(t, n))
            }
        }
    }),
    ...
    function dt(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
            O.set(t[i], "globalEval", !e || O.get(e[i], "globalEval"))
    }
    function ft(t, e) {
        var i, n, r, o, s, a, l, c;
        if (1 === e.nodeType) {
            if (O.hasData(t) && (o = O.access(t),
            s = O.set(e, o),
            c = o.events))
                ...
                c)
                    for (i = 0,
                    n = c[r].length; i < n; i++)
                        C.event.add(e, r, c[r][i]);
            H.hasData(t) && (a = H.access(t),
            l = C.extend({}, a),
            H.set(e, l))
        }
    }
    ...
    C.extend({
        clone: function(t, e, i) {
            var n, r, o, s, a, l, c, h = t.cloneNode(!0), u = C.contains(t.ownerDocument, t);
            if (!(v.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || C.isXMLDoc(t)))
                for (s = pt(h),
                n = 0,
                r = (o = pt(t)).length; n < r; n++)
                    a = o[n],
                    l = s[n],
                    void 0,
                    "input" === (c = l.nodeName.toLowerCase()) && Y.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (o = o || pt(t),
                    s = s || pt(h),
                    ...
                    ft(t, h);
            return 0 < (s = pt(h, "script")).length && dt(s, !u && pt(t, "script")),
            h
        },
        buildFragment: function(t, e, i, n) {
            for (var r, o, s, a, l, c, h = e.createDocumentFragment(), u = [], d = 0, f = t.length; d < f; d++)
                if ((r = t[d]) || 0 === r)
                    if ("object" === C.type(r))
                        C.merge(u, r.nodeType ? [r] : r);
                    else if (it.test(r)) {
                        for (o = o || h.appendChild(e.createElement("div")),
                        s = (et.exec(r) || ["", ""])[1].toLowerCase(),
                        a = lt[s] || lt._default,
                        o.innerHTML = a[1] + r.replace(tt, "<$1></$2>") + a[2],
                        c = a[0]; c--; )
                            o = o.lastChild;
                        C.merge(u, o.childNodes),
                        (o = h.firstChild).textContent = ""
                    } else
                        u.push(e.createTextNode(r));
            for (h.textContent = "",
            d = 0; r = u[d++]; )
                if ((!n || -1 === C.inArray(r, n)) && (l = C.contains(r.ownerDocument, r),
        ...
        cleanData: function(t) {
            for (var e, i, n, r, o = C.event.special, s = 0; void 0 !== (i = t[s]); s++) {
                if (C.acceptData(i) && ((r = i[O.expando]) && (e = O.cache[r]))) {
                    if (e.events)
                        for (n in e.events)
                            o[n] ? C.event.remove(i, n) : C.removeEvent(i, n, e.handle);
                    O.cache[r] && delete O.cache[r]
                }
    ...
    C.fn.extend({
        ...
        remove: function(t, e) {
            for (var i, n = t ? C.filter(t, this) : this, r = 0; null != (i = n[r]); r++)
                e || 1 !== i.nodeType || C.cleanData(pt(i)),
                i.parentNode && (e && C.contains(i.ownerDocument, i) && dt(pt(i, "script")),
                i.parentNode.removeChild(i));
            return this
        },
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (C.cleanData(pt(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return $(this, function(t) {
                ...
                if ("string" == typeof t && !nt.test(t) && !lt[(et.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (C.cleanData(pt(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        domManip: function(i, n) {
            i = g.apply([], i);
            var t, e, r, o, s, a, l = 0, c = this.length, h = this, u = c - 1, d = i[0], f = C.isFunction(d);
            if (f || 1 < c && "string" == typeof d && !v.checkClone && rt.test(d))
                return this.each(function(t) {
                    var e = h.eq(t);
                    f && (i[0] = d.call(this, t, e.html())),
                    e.domManip(i, n)
                });
            if (c && (e = (t = C.buildFragment(i, this[0].ownerDocument, !1, this)).firstChild,
            1 === t.childNodes.length && (t = e),
            e)) {
                for (o = (r = C.map(pt(t, "script"), ht)).length; l < c; l++)
                    s = t,
                    l !== u && (s = C.clone(s, !0, !0),
                    o && C.merge(r, pt(s, "script"))),
                    n.call(this[l], s, l);
                if (o)
                    ...
                    l = 0; l < o; l++)
                        s = r[l],
                        ot.test(s.type || "") && !O.access(s, "globalEval") && C.contains(a, s) && (s.src ? C._evalUrl && C._evalUrl(s.src) : C.globalEval(s.textContent.replace(at, "")))
            }
            return this
        }
    }),
    C.each({
        ...
        C.fn[t] = function(t) {
            for (var e, i = [], n = C(t), r = n.length - 1, o = 0; o <= r; o++)
    ...
    var gt, mt = {};
    function vt(t, e) {
        var i, n = C(e.createElement(t)).appendTo(e.body), r = p.getDefaultComputedStyle && (i = p.getDefaultComputedStyle(n[0])) ? i.display : C.css(n[0], "display");
        return n.detach(),
        r
    }
    function wt(t) {
        var e = w
          , i = mt[t];
        return i || ("none" !== (i = vt(t, e)) && i || ((e = (gt = (gt || C("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement))[0].contentDocument).write(),
        e.close(),
        i = vt(t, e),
        gt.detach()),
        mt[t] = i),
    ...
    var yt = /^margin/
      , _t = new RegExp("^(" + F + ")(?!px)[a-z%]+$","i")
      , bt = function(t) {
        return t.ownerDocument.defaultView.opener ? t.ownerDocument.defaultView.getComputedStyle(t, null) : p.getComputedStyle(t, null)
    };
    function xt(t, e, i) {
        var n, r, o, s, a = t.style;
        return (i = i || bt(t)) && (s = i.getPropertyValue(e) || i[e]),
        i && ("" !== s || C.contains(t.ownerDocument, t) || (s = C.style(t, e)),
        _t.test(s) && yt.test(e) && (n = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    !function() {
        var e, i, n = w.documentElement, r = w.createElement("div"), o = w.createElement("div");
        if (o.style) {
            function t() {
                ...
                o.innerHTML = "",
                n.appendChild(r);
                var t = p.getComputedStyle(o, null);
                e = "1%" !== t.top,
                i = "4px" === t.width,
                n.removeChild(r)
            }
            ...
            p.getComputedStyle && C.extend(v, {
                ...
                reliableMarginRight: function() {
                    var t, e = o.appendChild(w.createElement("div"));
                    return e.style.cssText = o.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
                    e.style.marginRight = e.style.width = "0",
                    o.style.width = "1px",
                    n.appendChild(r),
                    t = !parseFloat(p.getComputedStyle(e, null).marginRight),
                    n.removeChild(r),
                    o.removeChild(e),
                    t
                }
    ...
    function Dt(t, e) {
        if (e in t)
            return e;
        for (var i = e[0].toUpperCase() + e.slice(1), n = e, r = It.length; r--; )
            if ((e = It[r] + i)in t)
                return e;
        return n
    }
    ...
    function Nt(t, e, i, n, r) {
        for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; o < 4; o += 2)
            "margin" === i && (s += C.css(t, i + q[o], !0, r)),
            n ? ("content" === i && (s -= C.css(t, "padding" + q[o], !0, r)),
            "margin" !== i && (s -= C.css(t, "border" + q[o] + "Width", !0, r))) : (s += C.css(t, "padding" + q[o], !0, r),
            "padding" !== i && (s += C.css(t, "border" + q[o] + "Width", !0, r)));
        return s
    }
    function $t(t, e, i) {
        var n = !0
        ...
        if (r <= 0 || null == r) {
            if (((r = xt(t, e, o)) < 0 || null == r) && (r = t.style[e]),
            _t.test(r))
                return r;
            n = s && (v.boxSizingReliable() || r === t.style[e]),
            r = parseFloat(r) || 0
        }
    ...
    function Mt(t, e) {
        for (var i, n, r, o = [], s = 0, a = t.length; s < a; s++)
            (n = t[s]).style && (o[s] = O.get(n, "olddisplay"),
            i = n.style.display,
            e ? (o[s] || "none" !== i || (n.style.display = ""),
            "" === n.style.display && z(n) && (o[s] = O.access(n, "olddisplay", wt(n.nodeName)))) : (r = z(n),
            "none" === i && r || O.set(n, "olddisplay", r ? i : C.css(n, "display"))));
        for (s = 0; s < a; s++)
            (n = t[s]).style && (e && "none" !== n.style.display && "" !== n.style.display || (n.style.display = e ? o[s] || "" : "none"));
        return t
    }
    function Ot(t, e, i, n, r) {
        return new Ot.prototype.init(t,e,i,n,r)
    }
    C.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, o, s, a = C.camelCase(e), l = t.style;
                return e = C.cssProps[a] || (C.cssProps[a] = Dt(l, a)),
                s = C.cssHooks[e] || C.cssHooks[a],
                void 0 === i ? s && "get"in s && void 0 !== (r = s.get(t, !1, n)) ? r : l[e] : ("string" === (o = typeof i) && (r = Tt.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(C.css(t, e)),
                o = "number"),
                void (null != i && i == i && ("number" !== o || C.cssNumber[a] || (i += "px"),
                v.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"),
                s && "set"in s && void 0 === (i = s.set(t, i, n)) || (l[e] = i))))
            }
        },
        css: function(t, e, i, n) {
            var r, o, s, a = C.camelCase(e);
            return e = C.cssProps[a] || (C.cssProps[a] = Dt(t.style, a)),
            (s = C.cssHooks[e] || C.cssHooks[a]) && "get"in s && (r = s.get(t, !0, i)),
            void 0 === r && (r = xt(t, e, n)),
            "normal" === r && e in Lt && (r = Lt[e]),
            "" === i || i ? (o = parseFloat(r),
            !0 === i || C.isNumeric(o) ? o || 0 : r) : r
        }
    }),
    C.each(["height", "width"], function(t, r) {
        C.cssHooks[r] = {
            get: function(t, e, i) {
                return e ? kt.test(C.css(t, "display")) && 0 === t.offsetWidth ? C.swap(t, St, function() {
                    return $t(t, r, i)
                }) : $t(t, r, i) : void 0
            },
            set: function(t, e, i) {
                var n = i && bt(t);
                return At(0, e, i ? Nt(t, r, i, "border-box" === C.css(t, "boxSizing", !1, n), n) : 0)
            }
        }
    }),
    C.cssHooks.marginRight = Ct(v.reliableMarginRight, function(t, e) {
        return e ? C.swap(t, {
        ...
        C.cssHooks[r + o] = {
            expand: function(t) {
                for (var e = 0, i = {}, n = "string" == typeof t ? t.split(" ") : [t]; e < 4; e++)
                    i[r + q[e] + o] = n[e] || n[e - 2] || n[0];
                return i
            }
        },
        yt.test(r) || (C.cssHooks[r + o].set = At)
    }),
    C.fn.extend({
        css: function(t, e) {
    ...
    ((C.Tween = Ot).prototype = {
        ...
        run: function(t) {
            var e, i = Ot.propHooks[this.prop];
    ...
    C.fx.step = {};
    var Ht, Pt, Bt, jt, zt, Wt = /^(?:toggle|show|hide)$/, Rt = new RegExp("^(?:([+-])=|)(" + F + ")([a-z%]*)$","i"), Ft = /queueHooks$/, qt = [function(e, t, i) {
        var n, r, o, s, a, l, c, h = this, u = {}, d = e.style, f = e.nodeType && z(e), p = O.get(e, "fxshow");
        ...
        c = C.css(e, "display"),
        "inline" === ("none" === c ? O.get(e, "olddisplay") || wt(e.nodeName) : c) && "none" === C.css(e, "float") && (d.display = "inline-block")),
        ...
        t)
            ...
            Wt.exec(r)) {
                ...
                o = o || "toggle" === r,
                r === (f ? "hide" : "show")) {
                    if ("show" !== r || !p || void 0 === p[n])
                        continue;
                    f = !0
                }
                u[n] = p && p[n] || C.style(e, n)
            } else
                c = void 0;
        if (C.isEmptyObject(u))
            "inline" === ("none" === c ? wt(e.nodeName) : c) && (d.display = c);
        else
            for (n in p ? "hidden"in p && (f = p.hidden) : p = O.access(e, "fxshow", {}),
            o && (p.hidden = !f),
            f ? C(e).show() : h.done(function() {
                C(e).hide()
            }),
            h.done(function() {
                var t;
        ...
        "*": [function(t, e) {
            var i = this.createTween(t, e)
              , n = i.cur()
              , r = Rt.exec(e)
              , o = r && r[3] || (C.cssNumber[t] ? "" : "px")
              , s = (C.cssNumber[t] || "px" !== o && +n) && Rt.exec(C.css(i.elem, t))
              , a = 1
              , l = 20;
            if (s && s[3] !== o)
                for (o = o || s[3],
    ...
    function Vt(t, e) {
        ...
        for (e = e ? 1 : 0; n < 4; n += 2 - e)
            r["margin" + (i = q[n])] = r["padding" + i] = t;
        return e && (r.opacity = r.width = t),
        r
    }
    function Ut(t, e, i) {
        for (var n, r = (Yt[e] || []).concat(Yt["*"]), o = 0, s = r.length; o < s; o++)
            if (n = r[o].call(i, e, t))
                return n
    }
    function Zt(o, t, e) {
        var i, s, n = 0, r = qt.length, a = C.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var t = Ht || Xt(), e = Math.max(0, c.startTime + c.duration - t), i = 1 - (e / c.duration || 0), n = 0, r = c.tweens.length; n < r; n++)
                c.tweens[n].run(i);
    ...
    C.Animation = C.extend(Zt, {
        tweener: function(t, e) {
            for (var i, n = 0, r = (t = C.isFunction(t) ? (e = t,
            ["*"]) : t.split(" ")).length; n < r; n++)
                i = t[n],
                Yt[i] = Yt[i] || [],
                Yt[i].unshift(e)
        },
    ...
    C.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var t, e = O.get(this), i = e[s + "queue"], n = e[s + "queueHooks"], r = C.timers, o = i ? i.length : 0;
                for (e.finish = !0,
                C.queue(this, s, []),
    ...
    C.each(["toggle", "show", "hide"], function(t, n) {
        ...
        C.fn[n] = function(t, e, i) {
            return null == t || "boolean" == typeof t ? r.apply(this, arguments) : this.animate(Vt(n, !0), t, e, i)
        }
    }),
    C.each({
        slideDown: Vt("show"),
    ...
    C.fx.interval = 13,
    C.fx.start = function() {
        Pt = Pt || setInterval(C.fx.tick, C.fx.interval)
    }
    ,
    C.fx.stop = function() {
        clearInterval(Pt),
    ...
    ,
    Bt = w.createElement("input"),
    jt = w.createElement("select"),
    zt = jt.appendChild(w.createElement("option")),
    Bt.type = "checkbox",
    v.checkOn = "" !== Bt.value,
    v.optSelected = zt.selected,
    jt.disabled = !0,
    v.optDisabled = !zt.disabled,
    (Bt = w.createElement("input")).value = "t",
    Bt.type = "radio",
    v.radioValue = "t" === Bt.value;
    var Qt, Kt = C.expr.attrHandle;
    C.fn.extend({
        attr: function(t, e) {
            return $(this, C.attr, t, e, 1 < arguments.length)
        },
    ...
    C.extend({
        attr: function(t, e, i) {
            ...
            if (t && 3 !== o && 8 !== o && 2 !== o)
                return typeof t.getAttribute == X ? C.prop(t, e, i) : (1 === o && C.isXMLDoc(t) || (e = e.toLowerCase(),
                n = C.attrHooks[e] || (C.expr.match.bool.test(e) ? Qt : void 0)),
                void 0 === i ? n && "get"in n && null !== (r = n.get(t, e)) ? r : null == (r = C.find.attr(t, e)) ? void 0 : r : null !== i ? n && "set"in n && void 0 !== (r = n.set(t, i, e)) ? r : (t.setAttribute(e, i + ""),
                i) : void C.removeAttr(t, e))
        },
        removeAttr: function(t, e) {
            var i, n, r = 0, o = e && e.match(D);
            if (o && 1 === t.nodeType)
                for (; i = o[r++]; )
                    n = C.propFix[i] || i,
                    C.expr.match.bool.test(i) && (t[n] = !1),
                    t.removeAttribute(i)
        },
        attrHooks: {
            type: {
    ...
    C.fn.extend({
        prop: function(t, e) {
            return $(this, C.prop, t, e, 1 < arguments.length)
        },
    ...
    C.fn.extend({
        addClass: function(e) {
            var t, i, n, r, o, s, a = "string" == typeof e && e, l = 0, c = this.length;
            if (C.isFunction(e))
                return this.each(function(t) {
                    C(this).addClass(e.call(this, t, this.className))
                });
            if (a)
                for (t = (e || "").match(D) || []; l < c; l++)
                    if (n = 1 === (i = this[l]).nodeType && (i.className ? (" " + i.className + " ").replace(Jt, " ") : " ")) {
                        for (o = 0; r = t[o++]; )
                            n.indexOf(" " + r + " ") < 0 && (n += r + " ");
                        s = C.trim(n),
        ...
        removeClass: function(e) {
            var t, i, n, r, o, s, a = 0 === arguments.length || "string" == typeof e && e, l = 0, c = this.length;
            if (C.isFunction(e))
                return this.each(function(t) {
        ...
        toggleClass: function(r, e) {
            var o = typeof r;
            return "boolean" == typeof e && "string" == o ? e ? this.addClass(r) : this.removeClass(r) : this.each(C.isFunction(r) ? function(t) {
                C(this).toggleClass(r.call(this, t, this.className, e), e)
            }
            : function() {
                if ("string" == o)
                    for (var t, e = 0, i = C(this), n = r.match(D) || []; t = n[e++]; )
                        i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else
                    o != X && "boolean" != o || (this.className && O.set(this, "__className__", this.className),
                    this.className = this.className || !1 === r ? "" : O.get(this, "__className__") || "")
            }
            )
        },
        hasClass: function(t) {
    ...
    C.fn.extend({
        val: function(i) {
            var n, t, r, e = this[0];
            return arguments.length ? (r = C.isFunction(i),
            this.each(function(t) {
                var e;
                1 === this.nodeType && (null == (e = r ? i.call(this, t, C(this).val()) : i) ? e = "" : "number" == typeof e ? e += "" : C.isArray(e) && (e = C.map(e, function(t) {
                    return null == t ? "" : t + ""
                })),
                (n = C.valHooks[this.type] || C.valHooks[this.nodeName.toLowerCase()]) && "set"in n && void 0 !== n.set(this, e, "value") || (this.value = e))
            })) : e ? (n = C.valHooks[e.type] || C.valHooks[e.nodeName.toLowerCase()]) && "get"in n && void 0 !== (t = n.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(te, "") : null == t ? "" : t : void 0
        }
    }),
    C.extend({
        valHooks: {
            ...
            select: {
                get: function(t) {
                    for (var e, i, n = t.options, r = t.selectedIndex, o = "select-one" === t.type || r < 0, s = o ? null : [], a = o ? r + 1 : n.length, l = r < 0 ? a : o ? r : 0; l < a; l++)
                        if (!(!(i = n[l]).selected && l !== r || (v.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && C.nodeName(i.parentNode, "optgroup"))) {
                            if (e = C(i).val(),
                            o)
                                return e;
                            s.push(e)
                ...
                set: function(t, e) {
                    for (var i, n, r = t.options, o = C.makeArray(e), s = r.length; s--; )
                        ((n = r[s]).selected = 0 <= C.inArray(n.value, o)) && (i = !0);
    ...
    var ne = /#.*$/
      ...
      , ue = "*/".concat("*")
      , de = p.location.href
      , fe = le.exec(de.toLowerCase()) || [];
    function pe(o) {
        return function(t, e) {
            "string" != typeof t && (e = t,
            t = "*");
            var i, n = 0, r = t.toLowerCase().match(D) || [];
            if (C.isFunction(e))
                for (; i = r[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    C.extend({
        ...
        ajaxSetup: function(t, e) {
            return e ? me(me(t, C.ajaxSettings), e) : me(C.ajaxSettings, t)
        },
        ajaxPrefilter: pe(ce),
        ajaxTransport: pe(he),
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var h, u, d, i, f, n, p, r, g = C.ajaxSetup({}, e), m = g.context || g, v = g.context && (m.nodeType || m.jquery) ? C(m) : C.event, w = C.Deferred(), y = C.Callbacks("once memory"), _ = g.statusCode || {}, o = {}, s = {}, b = 0, a = "canceled", x = {
                readyState: 0,
                ...
                setRequestHeader: function(t, e) {
                    var i = t.toLowerCase();
                    return b || (t = s[i] = s[i] || t,
                    o[t] = e),
                    this
                },
                overrideMimeType: function(t) {
                    return b || (g.mimeType = t),
                    this
                },
            ...
            if (w.promise(x).complete = y.add,
            x.success = x.done,
            x.error = x.fail,
            g.url = ((t || g.url || de) + "").replace(ne, "").replace(ae, fe[1] + "//"),
            g.type = e.method || e.type || g.method || g.type,
            g.dataTypes = C.trim(g.dataType || "*").toLowerCase().match(D) || [""],
            null == g.crossDomain && (n = le.exec(g.url.toLowerCase()),
            g.crossDomain = !(!n || n[1] === fe[1] && n[2] === fe[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (fe[3] || ("http:" === fe[1] ? "80" : "443")))),
            ...
            g.hasContent = !se.test(g.type),
            u = g.url,
            g.hasContent || (g.data && (u = g.url += (ie.test(u) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (g.url = re.test(u) ? u.replace(re, "$1_=" + ee++) : u + (ie.test(u) ? "&" : "?") + "_=" + ee++)),
            g.ifModified && (C.lastModified[u] && x.setRequestHeader("If-Modified-Since", C.lastModified[u]),
            ...
            function l(t, e, i, n) {
                ...
                r ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (C.lastModified[u] = l),
                ...
                x.status = t,
                x.statusText = (e || c) + "",
                r ? w.resolveWith(m, [o, c, x]) : w.rejectWith(m, [x, c, s]),
                x.statusCode(_),
                _ = void 0,
                p && v.trigger(r ? "ajaxSuccess" : "ajaxError", [x, g, r ? o : s]),
                y.fireWith(m, [x, c]),
    ...
    C.each(["get", "post"], function(t, r) {
        C[r] = function(t, e, i, n) {
            return C.isFunction(e) && (n = n || i,
            i = e,
            e = void 0),
            C.ajax({
                url: t,
    ...
    C.fn.extend({
        wrapAll: function(e) {
            ...
            }) : (this[0] && (t = C(e, this[0].ownerDocument).eq(0).clone(!0),
    ...
    function xe(i, t, n, r) {
        ...
        if (C.isArray(t))
            C.each(t, function(t, e) {
                n || we.test(i) ? r(i, e) : xe(i + "[" + ("object" == typeof e ? t : "") + "]", e, n, r)
            });
        else if (n || "object" !== C.type(t))
            r(i, t);
        else
            for (e in t)
                xe(i + "[" + e + "]", t[e], n, r)
    ...
    C.param = function(t, e) {
        ...
        var n, r = [];
        if (void 0 === e && (e = C.ajaxSettings && C.ajaxSettings.traditional),
    ...
    C.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !C(this).is(":disabled") && be.test(this.nodeName) && !_e.test(t) && (this.checked || !Y.test(t))
            }).map(function(t, e) {
                var i = C(this).val();
    ...
    C.ajaxTransport(function(o) {
        var s;
        return v.cors || Te && !o.crossDomain ? {
            send: function(t, e) {
                var i, n = o.xhr(), r = ++Ce;
                ...
                s = function(t) {
                    return function() {
                        s && (delete ke[r],
                        s = n.onload = n.onerror = null,
                        "abort" === t ? n.abort() : "error" === t ? e(n.status, n.statusText) : e(Ee[n.status] || n.status, n.statusText, "string" == typeof n.responseText ? {
                            text: n.responseText
    ...
    C.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = Se.pop() || C.expando + "_" + ee++;
            return this[t] = !0,
            t
        }
    }),
    C.ajaxPrefilter("json jsonp", function(t, e, i) {
        var n, r, o, s = !1 !== t.jsonp && (Le.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Le.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (n = t.jsonpCallback = C.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        s ? t[s] = t[s].replace(Le, "$1" + n) : !1 !== t.jsonp && (t.url += (ie.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
    ...
    C.parseHTML = function(t, e, i) {
        ...
        var n = _.exec(t)
          , r = !i && [];
        return n ? [e.createElement(n[1])] : (n = C.buildFragment([t], e, r),
    ...
    ;
    var De = p.document.documentElement;
    function Ae(t) {
        return C.isWindow(t) ? t : 9 === t.nodeType && t.defaultView
    }
    C.offset = {
        setOffset: function(t, e, i) {
            var n, r, o, s, a, l, c = C.css(t, "position"), h = C(t), u = {};
            "static" === c && (t.style.position = "relative"),
            a = h.offset(),
            o = C.css(t, "top"),
            l = C.css(t, "left"),
            r = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (n = h.position()).top,
    ...
    C.fn.extend({
        offset: function(e) {
            ...
            C.contains(t, n) ? (typeof n.getBoundingClientRect != X && (r = n.getBoundingClientRect()),
            i = Ae(o),
            {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === C.css(i, "position") ? e = i.getBoundingClientRect() : (t = this.offsetParent(),
                e = this.offset(),
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || De; t && !C.nodeName(t, "html") && "static" === C.css(t, "position"); )
                    t = t.offsetParent;
                return t || De
            })
        }
    ...
    C.each({
        ...
        C.fn[e] = function(t) {
            return $(this, function(t, e, i) {
                var n = Ae(t);
                return void 0 === i ? n ? n[r] : t[e] : void (n ? n.scrollTo(o ? p.pageXOffset : i, o ? i : p.pageYOffset) : t[e] = i)
            }, e, t, arguments.length, null)
        }
    }),
    C.each(["top", "left"], function(t, i) {
        C.cssHooks[i] = Ct(v.pixelPosition, function(t, e) {
            return e ? (e = xt(t, i),
            _t.test(e) ? C(t).position()[i] + "px" : e) : void 0
        })
    }),
    C.each({
        Height: "height",
        ...
        C.each({
            ...
            C.fn[t] = function(t, e) {
                ...
                return $(this, function(t, e, i) {
                    var n;
                    return C.isWindow(t) ? t.document.documentElement["client" + o] : 9 === t.nodeType ? (n = t.documentElement,
                    Math.max(t.body["scroll" + o], n["scroll" + o], t.body["offset" + o], n["offset" + o], n["client" + o])) : void 0 === i ? C.css(t, e, r) : C.style(t, e, i, r)
                }, s, i ? t : void 0, i, null)
            }
        })
    }),
    ...
    return C.noConflict = function(t) {
        return p.$ === C && (p.$ = $e),
        t && p.jQuery === C && (p.jQuery = Ne),
        C
    }
    ,
    typeof t == X && (p.jQuery = p.$ = C),
    C
}),
function(t, e) {
    ...
    function f(t) {
        ...
        var e = v(t)
          ...
          , n = e.overflowX
          , r = e.overflowY;
        return /(auto|scroll)/.test(i + r + n) ? t : f(u(t))
    }
    function w(t) {
        var e = t && t.offsetParent
          , i = e && e.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TD", "TABLE"].indexOf(e.nodeName) && "static" === v(e, "position") ? w(e) : e : window.document.documentElement
    }
    function l(t) {
    ...
    function d(t, e) {
        ...
        if (t !== s && e !== s || n.contains(r))
            return function(t) {
                var e = t.nodeName;
                return "BODY" !== e && ("HTML" === e || w(t.firstElementChild) === t)
            }(s) ? s : w(s);
        var a = l(t);
        return a.host ? d(a.host, e) : d(t, l(e).host)
    }
    function p(t, e) {
        ...
        return (window.document.scrollingElement || r)[i]
    }
    function g(t, e) {
        var i = "x" === e ? "Left" : "Top"
    ...
    function n(t, e, i, n) {
        return M(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], F() ? i["offset" + t] + n["margin" + ("Height" === t ? "Top" : "Left")] + n["margin" + ("Height" === t ? "Bottom" : "Right")] : 0)
    }
    function m() {
    ...
    function b(t, e) {
        ...
        return (i ? e.contains(s) : e === s && "BODY" !== s.nodeName) && (h = function(t, e, i) {
        ...
        if ("viewport" === n)
            r = function(t) {
                var e = window.document.documentElement
                  ...
                  , r = M(e.clientHeight, window.innerHeight || 0)
                  , o = p(e)
                  , s = p(e, "left");
                return y({
            ...
            if ("HTML" !== s.nodeName || function t(e) {
                var i = e.nodeName;
                return "BODY" !== i && "HTML" !== i && ("fixed" === v(e, "position") || t(u(e)))
            }(o))
                r = a;
            else {
                var l = m()
    ...
    function S(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && o(e) && (i.offsets.popper = y(i.offsets.popper),
    ...
    function I(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && h(n[t]) && (e = "px"),
            i.style[t] = n[t] + e
        })
    }
    function D(t, e, i) {
        ...
        return (c = c.map(function(t, e) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, n) {
                    var r, o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), s = +o[1], a = o[2];
                    if (!s)
                        return t;
                    if (0 !== a.indexOf("%"))
                        return "vh" !== a && "vw" !== a ? s : ("vh" === a ? M(document.documentElement.clientHeight, window.innerHeight || 0) : M(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * s;
                    switch (a) {
                    case "%p":
                        r = i;
                        break;
    ...
    for (var N = Math.min, $ = Math.floor, M = Math.max, s = ["native code", "[object MutationObserverConstructor]"], O = "undefined" != typeof window, H = ["Edge", "Trident", "Firefox"], P = 0, B = 0; B < H.length; B += 1)
        if (O && 0 <= navigator.userAgent.indexOf(H[B])) {
            P = 1;
            break
        }
    function j(t, e, i) {
    ...
    var z, W, R = O && (W = window.MutationObserver,
    s.some(function(t) {
    ...
    , F = function() {
        return null == z && (z = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        z
    }, q = function(t, e, i) {
    ...
    , X = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], V = X.slice(3), U = "flip", Z = "clockwise", Q = "counterclockwise", K = (q(G, [{
        key: "update",
        value: function() {
            return function() {
    ...
    function G(t, e) {
        ...
        Object.keys(Y({}, G.Defaults.modifiers, n.modifiers)).forEach(function(t) {
            i.options.modifiers[t] = Y({}, G.Defaults.modifiers[t] || {}, n.modifiers ? n.modifiers[t] : {})
        }),
    ...
    K.Defaults = {
        ...
        modifiers: {
            ...
            offset: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    var i, n = e.offset, r = t.placement, o = t.offsets, s = o.popper, a = o.reference, l = r.split("-")[0];
                    return i = h(+n) ? [+n, 0] : A(n, s, a, l),
                    "left" === l ? (s.top += i[0],
            ...
            preventOverflow: {
                ...
                enabled: !0,
                fn: function(t, n) {
                    var e = n.boundariesElement || w(t.instance.popper);
                    t.instance.reference === e && (e = w(e));
                    var r = x(t.instance.popper, t.instance.reference, n.padding, e);
                    n.boundaries = r;
                    var i = n.priority
                      , o = t.offsets.popper
                      , s = {
                        primary: function(t) {
                            var e = o[t];
                            return o[t] < r[t] && !n.escapeWithReference && (e = M(o[t], r[t])),
                            j({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , i = o[e];
                            return o[t] > r[t] && !n.escapeWithReference && (i = N(o[e], r[t] - ("right" === t ? o.width : o.height))),
                            j({}, e, i)
                        }
                    };
            ...
            arrow: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    if (!D(t.instance.modifiers, "arrow", "keepTogether"))
                        return t;
                    var i = e.element;
                    if ("string" == typeof i) {
                    ...
                    var n = t.placement.split("-")[0]
                      ...
                      , d = a ? "bottom" : "right"
                      , f = C(i)[l];
                    s[d] - f < o[h] && (t.offsets.popper[h] -= o[h] - (s[d] - f)),
                    s[h] + f > o[d] && (t.offsets.popper[h] += s[h] + f - o[d]);
                    var p = s[h] + s[l] / 2 - f / 2
                      , g = v(t.instance.popper, "margin" + c).replace("px", "")
                      , m = p - y(t.offsets.popper)[h] - g;
                    return m = M(N(o[l] - f, m), 0),
                    t.arrowElement = i,
                    t.offsets.arrow = {},
                    t.offsets.arrow[h] = Math.round(m),
                    t.offsets.arrow[u] = "",
                    t
                },
                element: "[x-arrow]"
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(f, p) {
                    if (t(f.instance.modifiers, "inner"))
                        return f;
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        var i = f.offsets.popper
                          ...
                          , r = $
                          , o = "left" === m && r(i.right) > r(n.left) || "right" === m && r(i.left) < r(n.right) || "top" === m && r(i.bottom) > r(n.top) || "bottom" === m && r(i.top) < r(n.bottom)
                          , s = r(i.left) < r(g.left)
                          , a = r(i.right) > r(g.right)
                          , l = r(i.top) < r(g.top)
                          , c = r(i.bottom) > r(g.bottom)
                          , h = "left" === m && s || "right" === m && a || "top" === m && l || "bottom" === m && c
                          , u = -1 !== ["top", "bottom"].indexOf(m)
                          , d = !!p.flipVariations && (u && "start" === w && s || u && "end" === w && a || !u && "start" === w && l || !u && "end" === w && c);
                        (o || h || d) && (f.flipped = !0,
                        (o || h) && (m = y[e + 1]),
                        d && (w = function(t) {
                        ...
                        f.placement = m + (w ? "-" + w : ""),
                        f.offsets.popper = Y({}, f.offsets.popper, E(f.instance.popper, f.offsets.reference, f.placement)),
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(t) {
                    if (!D(t.instance.modifiers, "hide", "preventOverflow"))
                        return t;
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var s, a, l = void 0 === o ? e.gpuAcceleration : o, c = _(w(t.instance.popper)), h = {
                        position: r.position
                    }, u = {
                        left: $(r.left),
                        top: $(r.top),
                        bottom: $(r.bottom),
                        right: $(r.right)
                    }, d = "bottom" === i ? "top" : "bottom", f = "right" === n ? "left" : "right", p = L("transform");
                    if (a = "bottom" == d ? -c.height + u.bottom : u.top,
                    s = "right" == f ? -c.width + u.right : u.left,
                    l && p)
            ...
            applyStyle: {
                ...
                onLoad: function(t, e, i, n, r) {
                    var o = c(0, e, t)
                      , s = a(i.placement, o, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
...
function(t, e) {
            ...
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    ...
                    if (!new RegExp(r).test(s))
                        throw new Error(t.toUpperCase() + ': Option "' + n + '" provided type "' + s + '" but expected type "' + r + '".')
                }
            var a
        },
    ...
    var r, a = "alert", l = "bs.alert", c = "." + l, h = p.fn[a], d = {
        CLOSE: "close" + c,
        CLOSED: "closed" + c,
        CLICK_DATA_API: "click" + c + ".data-api"
    }, f = ((r = m.prototype).close = function(t) {
        var e = this._element;
    ...
    ;
    var v, w = "button", y = "bs.button", _ = "." + y, b = ".data-api", x = p.fn[w], C = "active", k = '[data-toggle^="button"]', E = 'input:not([type="hidden"])', T = {
        CLICK_DATA_API: "click" + _ + b,
        FOCUS_BLUR_DATA_API: "focus" + _ + b + " blur" + _ + b,
        LOAD_DATA_API: "load" + _ + b
    }, S = ((v = L.prototype).toggle = function() {
        var t = !0
          , e = !0
        ...
        if (i) {
            ...
            if (n) {
                if ("radio" === n.type)
                    if (n.checked && this._element.classList.contains(C))
                        t = !1;
                    else {
                    ...
                    "checkbox" === n.type ? "LABEL" === this._element.tagName && n.checked === this._element.classList.contains(C) && (t = !1) : t = !1;
                t && (n.checked = !this._element.classList.contains(C),
                p(n).trigger("change")),
                n.focus(),
                e = !1
            }
        }
        this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(C)),
    ...
    p(window).on(T.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), e = 0, i = t.length; e < i; e++) {
            var n = t[e]
              , r = n.querySelector(E);
            r.checked || r.hasAttribute("checked") ? n.classList.add(C) : n.classList.remove(C)
        }
    ...
    p.fn[w] = S._jQueryInterface,
    p.fn[w].Constructor = S,
    p.fn[w].noConflict = function() {
        return p.fn[w] = x,
        S._jQueryInterface
    }
    ;
    var I, D = "carousel", A = "bs.carousel", N = "." + A, $ = ".data-api", M = p.fn[D], O = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, z = "active", W = ".active.carousel-item", R = {
        TOUCH: "touch",
        PEN: "pen"
    }, F = ((I = q.prototype).next = function() {
    ...
    I._addTouchEventListeners = function() {
        ...
        if (this._touchSupported) {
            var e = function(t) {
              ...
              , n = function(t) {
                i._pointerEvent && R[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX),
                i._handleSwipe(),
    ...
    I._slide = function(t, e) {
        var i, n, r, o = this, s = this._element.querySelector(W), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l), h = Boolean(this._interval);
        if (r = t === P ? (i = "carousel-item-left",
        ...
        l && p(l).hasClass(z))
            ...
            if (p(this._element).hasClass("slide")) {
                ...
                p(s).one(g.TRANSITION_END, function() {
                    p(l).removeClass(i + " " + n).addClass(z),
                    p(s).removeClass(z + " " + n + " " + i),
                    o._isSliding = !1,
                    setTimeout(function() {
    ...
    ,
    q._dataApiClickHandler = function(t) {
    ...
    p(document).on(j.CLICK_DATA_API, "[data-slide], [data-slide-to]", F._dataApiClickHandler),
    ...
    p.fn[D] = F._jQueryInterface,
    p.fn[D].Constructor = F,
    p.fn[D].noConflict = function() {
        return p.fn[D] = M,
        F._jQueryInterface
    }
    ;
    var Y, X = "collapse", V = "bs.collapse", U = "." + V, Z = p.fn[X], Q = {
        toggle: !0,
        parent: ""
    }, K = {
        toggle: "boolean",
    ...
    }, J = "show", tt = "collapse", et = "collapsing", it = "collapsed", nt = '[data-toggle="collapse"]', rt = ((Y = ot.prototype).toggle = function() {
        p(this._element).hasClass(J) ? this.hide() : this.show()
    }
    ,
    Y.show = function() {
        var t, e, i = this;
        if (!(this._isTransitioning || p(this._element).hasClass(J) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
        ...
        t && (e = p(t).not(this._selector).data(V)) && e._isTransitioning))) {
            var n = p.Event(G.SHOW);
            if (p(this._element).trigger(n),
            !n.isDefaultPrevented()) {
                t && (ot._jQueryInterface.call(p(t).not(this._selector), "hide"),
                e || p(t).data(V, null));
                var r = this._getDimension();
                p(this._element).removeClass(tt).addClass(et),
                this._element.style[r] = 0,
                this._triggerArray.length && p(this._triggerArray).removeClass(it).attr("aria-expanded", !0),
                this.setTransitioning(!0);
                var o = "scroll" + (r[0].toUpperCase() + r.slice(1))
                  , s = g.getTransitionDurationFromElement(this._element);
                p(this._element).one(g.TRANSITION_END, function() {
                    p(i._element).removeClass(et).addClass(tt).addClass(J),
                    i._element.style[r] = "",
                    i.setTransitioning(!1),
                    p(i._element).trigger(G.SHOWN)
    ...
    Y.hide = function() {
        ...
        if (!this._isTransitioning && p(this._element).hasClass(J)) {
            ...
            !e.isDefaultPrevented()) {
                ...
                p(this._element).addClass(et).removeClass(tt).removeClass(J);
                var n = this._triggerArray.length;
                if (0 < n)
                    for (var r = 0; r < n; r++) {
                        var o = this._triggerArray[r]
                          , s = g.getSelectorFromElement(o);
                        null !== s && (p([].slice.call(document.querySelectorAll(s))).hasClass(J) || p(o).addClass(it).attr("aria-expanded", !1))
                    }
                this.setTransitioning(!0),
                ...
                p(this._element).one(g.TRANSITION_END, function() {
                    ...
                    p(t._element).removeClass(et).addClass(tt).trigger(G.HIDDEN)
    ...
    Y._getConfig = function(t) {
        return (t = s({}, Q, {}, t)).toggle = Boolean(t.toggle),
        g.typeCheckConfig(X, t, K),
        t
    }
    ,
    ...
    Y._getParent = function() {
        ...
        return p(n).each(function(t, e) {
            i._addAriaAndCollapsedClass(ot._getTargetFromElement(e), [e])
        }),
        t
    }
    ,
    Y._addAriaAndCollapsedClass = function(t, e) {
        var i = p(t).hasClass(J);
        e.length && p(e).toggleClass(it, !i).attr("aria-expanded", i)
    }
    ,
    ...
    ot._jQueryInterface = function(n) {
        return this.each(function() {
            var t = p(this)
              , e = t.data(V)
              , i = s({}, Q, {}, t.data(), {}, "object" == typeof n && n ? n : {});
    ...
    function ot(e, t) {
        ...
        for (var i = [].slice.call(document.querySelectorAll(nt)), n = 0, r = i.length; n < r; n++) {
            var o = i[n]
              , s = g.getSelectorFromElement(o)
    ...
    p(document).on(G.CLICK_DATA_API, nt, function(t) {
    ...
    p.fn[X] = rt._jQueryInterface,
    p.fn[X].Constructor = rt,
    p.fn[X].noConflict = function() {
        return p.fn[X] = Z,
        rt._jQueryInterface
    }
    ;
    var st, at = "dropdown", lt = "bs.dropdown", ct = "." + lt, ht = ".data-api", ut = p.fn[at], dt = new RegExp("38|40|27"), ft = {
        HIDE: "hide" + ct,
        HIDDEN: "hidden" + ct,
        SHOW: "show" + ct,
        SHOWN: "shown" + ct,
    ...
    }, pt = "disabled", gt = "show", mt = "dropdown-menu-right", vt = '[data-toggle="dropdown"]', wt = ".dropdown-menu", yt = {
        offset: 0,
        flip: !0,
    ...
    }, bt = ((st = xt.prototype).toggle = function() {
    ...
    st.show = function(t) {
        if (void 0 === t && (t = !1),
        !(this._element.disabled || p(this._element).hasClass(pt) || p(this._menu).hasClass(gt))) {
            var e = {
                relatedTarget: this._element
            }
              , i = p.Event(ft.SHOW, e)
              , n = xt._getParentFromElement(this._element);
            if (p(n).trigger(i),
            !i.isDefaultPrevented()) {
                if (!this._inNavbar && t) {
                    ...
                    var r = this._element;
                    "parent" === this._config.reference ? r = n : g.isElement(this._config.reference) && (r = this._config.reference,
                ...
                p(n).toggleClass(gt).trigger(p.Event(ft.SHOWN, e))
            }
        }
    }
    ,
    st.hide = function() {
        if (!this._element.disabled && !p(this._element).hasClass(pt) && p(this._menu).hasClass(gt)) {
            var t = {
                relatedTarget: this._element
            }
              , e = p.Event(ft.HIDE, t)
              , i = xt._getParentFromElement(this._element);
            p(i).trigger(e),
            e.isDefaultPrevented() || (this._popper && this._popper.destroy(),
            p(this._menu).toggleClass(gt),
            p(i).toggleClass(gt).trigger(p.Event(ft.HIDDEN, t)))
        }
    }
    ,
    st.dispose = function() {
    ...
    st._addEventListeners = function() {
        var e = this;
        p(this._element).on(ft.CLICK, function(t) {
            t.preventDefault(),
            t.stopPropagation(),
            e.toggle()
        })
    ...
    st._getConfig = function(t) {
        ...
        g.typeCheckConfig(at, t, this.constructor.DefaultType),
        t
    }
    ,
    st._getMenuElement = function() {
        if (!this._menu) {
            var t = xt._getParentFromElement(this._element);
    ...
    st._getPlacement = function() {
        ...
        p(this._menu).hasClass(mt) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : p(this._menu).hasClass(mt) && (e = "bottom-end"),
        e
    }
    ,
    ...
    xt._jQueryInterface = function(e) {
        return this.each(function() {
            var t = p(this).data(lt);
            if (t || (t = new xt(this,"object" == typeof e ? e : null),
            p(this).data(lt, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
    ...
    ,
    xt._clearMenus = function(t) {
        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
            for (var e = [].slice.call(document.querySelectorAll(vt)), i = 0, n = e.length; i < n; i++) {
                var r = xt._getParentFromElement(e[i])
                  , o = p(e[i]).data(lt)
                  , s = {
                    relatedTarget: e[i]
                };
                ...
                o) {
                    var a = o._menu;
                    if (p(r).hasClass(gt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(r, t.target))) {
                        var l = p.Event(ft.HIDE, s);
                        p(r).trigger(l),
                        ...
                        p(a).removeClass(gt),
                        p(r).removeClass(gt).trigger(p.Event(ft.HIDDEN, s)))
                    }
                }
            }
    }
    ,
    xt._getParentFromElement = function(t) {
        var e, i = g.getSelectorFromElement(t);
        return i && (e = document.querySelector(i)),
        e || t.parentNode
    }
    ,
    xt._dataApiKeydownHandler = function(t) {
        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(wt).length)) : dt.test(t.which)) && (t.preventDefault(),
        t.stopPropagation(),
        !this.disabled && !p(this).hasClass(pt))) {
            var e = xt._getParentFromElement(this)
              , i = p(e).hasClass(gt);
            if (i || 27 !== t.which)
    ...
    p(document).on(ft.KEYDOWN_DATA_API, vt, bt._dataApiKeydownHandler).on(ft.KEYDOWN_DATA_API, wt, bt._dataApiKeydownHandler).on(ft.CLICK_DATA_API + " " + ft.KEYUP_DATA_API, bt._clearMenus).on(ft.CLICK_DATA_API, vt, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        bt._jQueryInterface.call(p(this), "toggle")
    ...
    ;
    var Ct, kt = "modal", Et = "bs.modal", Tt = "." + Et, St = p.fn[kt], Lt = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
        ...
        HIDE: "hide" + Tt,
        HIDE_PREVENTED: "hidePrevented" + Tt,
        HIDDEN: "hidden" + Tt,
        SHOW: "show" + Tt,
        SHOWN: "shown" + Tt,
        FOCUSIN: "focusin" + Tt,
    ...
    }, At = "modal-open", Nt = "fade", $t = "show", Mt = "modal-static", Ot = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Ht = ".sticky-top", Pt = ((Ct = Bt.prototype).toggle = function(t) {
    ...
    Ct.show = function(t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
            p(this._element).hasClass(Nt) && (this._isTransitioning = !0);
            var i = p.Event(Dt.SHOW, {
                relatedTarget: t
            });
            ...
            p(this._element).on(Dt.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                return e.hide(t)
            }),
            p(this._dialog).on(Dt.MOUSEDOWN_DISMISS, function() {
                p(e._element).one(Dt.MOUSEUP_DISMISS, function(t) {
    ...
    ,
    Ct.handleUpdate = function() {
        this._adjustDialog()
    }
    ,
    Ct._getConfig = function(t) {
        return t = s({}, Lt, {}, t),
        g.typeCheckConfig(kt, t, It),
        t
    }
    ,
    Ct._triggerBackdropTransition = function() {
        var t = this;
        if ("static" === this._config.backdrop) {
            var e = p.Event(Dt.HIDE_PREVENTED);
            if (p(this._element).trigger(e),
            e.defaultPrevented)
                return;
    ...
    ,
    Ct._showElement = function(t) {
        var e = this
          , i = p(this._element).hasClass(Nt)
    ...
    ,
    Ct._enforceFocus = function() {
        var e = this;
        p(document).off(Dt.FOCUSIN).on(Dt.FOCUSIN, function(t) {
            document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
        })
    }
    ,
    Ct._setEscapeEvent = function() {
        var e = this;
        this._isShown && this._config.keyboard ? p(this._element).on(Dt.KEYDOWN_DISMISS, function(t) {
            27 === t.which && e._triggerBackdropTransition()
        }) : this._isShown || p(this._element).off(Dt.KEYDOWN_DISMISS)
    }
    ,
    Ct._setResizeEvent = function() {
        var e = this;
        this._isShown ? p(window).on(Dt.RESIZE, function(t) {
            return e.handleUpdate(t)
        }) : p(window).off(Dt.RESIZE)
    }
    ,
    Ct._hideModal = function() {
        var t = this;
        ...
        this._isTransitioning = !1,
        this._showBackdrop(function() {
            p(document.body).removeClass(At),
            t._resetAdjustments(),
            t._resetScrollbar(),
            p(t._element).trigger(Dt.HIDDEN)
        })
    }
    ,
    Ct._removeBackdrop = function() {
        this._backdrop && (p(this._backdrop).remove(),
        this._backdrop = null)
    }
    ,
    Ct._showBackdrop = function(t) {
        var e = this
          , i = p(this._element).hasClass(Nt) ? Nt : "";
        if (this._isShown && this._config.backdrop) {
            if (this._backdrop = document.createElement("div"),
            this._backdrop.className = "modal-backdrop",
            i && this._backdrop.classList.add(i),
            p(this._backdrop).appendTo(document.body),
            p(this._element).on(Dt.CLICK_DISMISS, function(t) {
                e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
            }),
            i && g.reflow(this._backdrop),
            p(this._backdrop).addClass($t),
            !t)
                return;
            if (!i)
                return void t();
            ...
            p(this._backdrop).removeClass($t);
            var r = function() {
                e._removeBackdrop(),
                t && t()
            };
            if (p(this._element).hasClass(Nt)) {
    ...
    ,
    Ct._adjustDialog = function() {
        var t = this._element.scrollHeight > document.documentElement.clientHeight;
        !this._isBodyOverflowing && t && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
        this._isBodyOverflowing && !t && (this._element.style.paddingRight = this._scrollbarWidth + "px")
    }
    ,
    Ct._resetAdjustments = function() {
        this._element.style.paddingLeft = "",
        this._element.style.paddingRight = ""
    }
    ,
    Ct._checkScrollbar = function() {
        var t = document.body.getBoundingClientRect();
        this._isBodyOverflowing = t.left + t.right < window.innerWidth,
        this._scrollbarWidth = this._getScrollbarWidth()
    }
    ,
    Ct._setScrollbar = function() {
        var r = this;
        ...
        p(document.body).addClass(At)
    }
    ,
    Ct._resetScrollbar = function() {
        var t = [].slice.call(document.querySelectorAll(Ot));
        p(t).each(function(t, e) {
    ...
    ,
    Ct._getScrollbarWidth = function() {
    ...
    ,
    Bt._jQueryInterface = function(i, n) {
        return this.each(function() {
            var t = p(this).data(Et)
              , e = s({}, Lt, {}, p(this).data(), {}, "object" == typeof i && i ? i : {});
            if (t || (t = new Bt(this,e),
            p(this).data(Et, t)),
            "string" == typeof i) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    p(document).on(Dt.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        var e, i = this, n = g.getSelectorFromElement(this);
        n && (e = document.querySelector(n));
        var r = p(e).data(Et) ? "toggle" : s({}, p(e).data(), {}, p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var o = p(e).one(Dt.SHOW, function(t) {
            t.isDefaultPrevented() || o.one(Dt.HIDDEN, function() {
                p(i).is(":visible") && i.focus()
            })
        });
        Pt._jQueryInterface.call(p(e), r, this)
    }),
    p.fn[kt] = Pt._jQueryInterface,
    p.fn[kt].Constructor = Pt,
    ...
    function Rt(t, o, e) {
        ...
        if (e && "function" == typeof e)
            return e(t);
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), n = function(t) {
            var e = a[t]
            ...
            n.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === jt.indexOf(i) || Boolean(t.nodeValue.match(zt) || t.nodeValue.match(Wt));
    ...
    var Ft, qt = "tooltip", Yt = "bs.tooltip", Xt = "." + Yt, Vt = p.fn[qt], Ut = "bs-tooltip", Zt = new RegExp("(^|\\s)" + Ut + "\\S+","g"), Qt = ["sanitize", "whiteList", "sanitizeFn"], Kt = {
        animation: "boolean",
        template: "string",
    ...
    }, ie = "fade", ne = "show", re = "hover", oe = "focus", se = ((Ft = ae.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    Ft.disable = function() {
    ...
    Ft.toggle = function(t) {
        if (this._isEnabled)
            if (t) {
                ...
                if (p(this.getTipElement()).hasClass(ne))
    ...
    Ft.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            this.setContent(),
            this.config.animation && p(r).addClass(ie);
            ...
            this._popper = new u(this.element,r,this._getPopperConfig(a)),
            p(r).addClass(ne),
    ...
    Ft.hide = function(t) {
        function e() {
            i._hoverState !== te && n.parentNode && n.parentNode.removeChild(n),
            i._cleanTipClass(),
    ...
    Ft.addAttachmentClass = function(t) {
        p(this.getTipElement()).addClass(Ut + "-" + t)
    }
    ,
    ...
    Ft.setContent = function() {
        ...
        p(t).removeClass(ie + " " + ne)
    }
    ,
    Ft.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Rt(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    ,
    Ft._getPopperConfig = function(t) {
        var e = this;
        return s({}, {
            placement: t,
            modifiers: {
    ...
    Ft._enter = function(t, e) {
        ...
        t && (e._activeTrigger["focusin" === t.type ? oe : re] = !0),
        p(e.getTipElement()).hasClass(ne) || e._hoverState === te ? e._hoverState = te : (clearTimeout(e._timeout),
        e._hoverState = te,
    ...
    Ft._leave = function(t, e) {
        ...
        (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        p(t.currentTarget).data(i, e)),
        t && (e._activeTrigger["focusout" === t.type ? oe : re] = !1),
    ...
    Ft._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (p(t).removeClass(ie),
    ...
    ae._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this).data(Yt)
              , e = "object" == typeof i && i;
            if ((t || !/dispose|hide/.test(i)) && (t || (t = new ae(this,e),
            p(this).data(Yt, t)),
            "string" == typeof i)) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    p.fn[qt] = se._jQueryInterface,
    p.fn[qt].Constructor = se,
    ...
    var le = "popover"
      ...
      , ve = function(t) {
        ...
        r.addAttachmentClass = function(t) {
            p(this.getTipElement()).addClass(de + "-" + t)
        }
        ,
    ...
    p.fn[le] = ve._jQueryInterface,
    p.fn[le].Constructor = ve,
    p.fn[le].noConflict = function() {
        return p.fn[le] = ue,
        ve._jQueryInterface
    }
    ;
    var we, ye = "scrollspy", _e = "bs.scrollspy", be = "." + _e, xe = p.fn[ye], Ce = {
        offset: 10,
        method: "auto",
        target: ""
    }, ke = {
        ...
        ACTIVATE: "activate" + be,
        SCROLL: "scroll" + be,
        LOAD_DATA_API: "load" + be + ".data-api"
    }, Te = "active", Se = ".nav, .list-group", Le = ".nav-link", Ie = ".list-group-item", De = "position", Ae = ((we = Ne.prototype).refresh = function() {
        var e = this
          , t = this._scrollElement === this._scrollElement.window ? "offset" : De
          , r = "auto" === this._config.method ? t : this._config.method
          , o = r === De ? this._getScrollTop() : 0;
        this._offsets = [],
        this._targets = [],
    ...
    ,
    we._getConfig = function(t) {
        if ("string" != typeof (t = s({}, Ce, {}, "object" == typeof t && t ? t : {})).target) {
            var e = p(t.target).attr("id");
            e || (e = g.getUID(ye),
            p(t.target).attr("id", e)),
            t.target = "#" + e
        }
        return g.typeCheckConfig(ye, t, ke),
        t
    }
    ,
    ...
    we._activate = function(e) {
        ...
        i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(Te),
        i.addClass(Te)) : (i.addClass(Te),
        i.parents(Se).prev(Le + ", " + Ie).addClass(Te),
        i.parents(Se).prev(".nav-item").children(Le).addClass(Te)),
        p(this._scrollElement).trigger(Ee.ACTIVATE, {
            relatedTarget: e
        })
    }
    ,
    ...
    ,
    Ne._jQueryInterface = function(e) {
        return this.each(function() {
    ...
    function Ne(t, e) {
        ...
        this._config = this._getConfig(e),
        this._selector = this._config.target + " " + Le + "," + this._config.target + " " + Ie + "," + this._config.target + " .dropdown-item",
        this._offsets = [],
        this._targets = [],
        this._activeTarget = null,
        this._scrollHeight = 0,
        p(this._scrollElement).on(Ee.SCROLL, function(t) {
            return i._process(t)
        }),
        this.refresh(),
        this._process()
    }
    p(window).on(Ee.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), e = t.length; e--; ) {
            var i = p(t[e]);
            Ae._jQueryInterface.call(i, i.data())
        }
    }),
    p.fn[ye] = Ae._jQueryInterface,
    p.fn[ye].Constructor = Ae,
    p.fn[ye].noConflict = function() {
        return p.fn[ye] = xe,
        Ae._jQueryInterface
    }
    ;
    var $e, Me = "bs.tab", Oe = "." + Me, He = p.fn.tab, Pe = {
        HIDE: "hide" + Oe,
        HIDDEN: "hidden" + Oe,
        SHOW: "show" + Oe,
        SHOWN: "shown" + Oe,
        CLICK_DATA_API: "click" + Oe + ".data-api"
    }, Be = "active", je = ".active", ze = "> li > .active", We = (($e = Re.prototype).show = function() {
        var i = this;
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Be) || p(this._element).hasClass("disabled"))) {
            var t, n, e = p(this._element).closest(".nav, .list-group")[0], r = g.getSelectorFromElement(this._element);
            if (e) {
                var o = "UL" === e.nodeName || "OL" === e.nodeName ? ze : je;
                n = (n = p.makeArray(p(e).find(o)))[n.length - 1]
            }
            var s = p.Event(Pe.HIDE, {
                relatedTarget: this._element
            })
              , a = p.Event(Pe.SHOW, {
                relatedTarget: n
    ...
    $e._activate = function(t, e, i) {
        ...
        var r = this
          , o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(je) : p(e).find(ze))[0]
          , s = i && o && p(o).hasClass("fade");
        if (o && s) {
    ...
    p(document).on(Pe.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        We._jQueryInterface.call(p(this), "show")
    }),
    p.fn.tab = We._jQueryInterface,
    p.fn.tab.Constructor = We,
    p.fn.tab.noConflict = function() {
        return p.fn.tab = He,
        We._jQueryInterface
    }
    ;
    var Fe, qe = "toast", Ye = "bs.toast", Xe = "." + Ye, Ve = p.fn[qe], Ue = {
        CLICK_DISMISS: "click.dismiss" + Xe,
        HIDE: "hide" + Xe,
        HIDDEN: "hidden" + Xe,
        SHOW: "show" + Xe,
        SHOWN: "shown" + Xe
    }, Ze = "show", Qe = "showing", Ke = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, Ge = {
        ...
        autohide: !0,
        delay: 500
    }, Je = ((Fe = ti.prototype).show = function() {
        var t = this
          , e = p.Event(Ue.SHOW);
        if (p(this._element).trigger(e),
        !e.isDefaultPrevented()) {
    ...
    Fe.dispose = function() {
        ...
        p(this._element).off(Ue.CLICK_DISMISS),
        p.removeData(this._element, Ye),
        this._element = null,
        this._config = null
    }
    ,
    Fe._getConfig = function(t) {
        return t = s({}, Ge, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}),
    ...
    Fe._setListeners = function() {
        var t = this;
        p(this._element).on(Ue.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
            return t.hide()
        })
    }
    ,
    Fe._close = function() {
        function t() {
            ...
            p(e._element).trigger(Ue.HIDDEN)
        }
        var e = this;
    ...
    ti._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this)
              , e = t.data(Ye);
            if (e || (e = new ti(this,"object" == typeof i && i),
            t.data(Ye, e)),
            "string" == typeof i) {
                if (void 0 === e[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    p.fn[qe] = Je._jQueryInterface,
    p.fn[qe].Constructor = Je,
...
function(t, e) {
    ...
    var g = Array.prototype
      ...
      , v = g.includes || h;
    function y(t, e) {
        return t && (M(t) ? m : v).call(t, e)
    }
    var _ = g.findIndex || function(t) {
    ...
    function H(t) {
        return O(t) || M(t) && !isNaN(t - parseFloat(t))
    }
    function P(t) {
    ...
    function j(t) {
        return $(t) ? t : "true" === t || "1" === t || "" === t || "false" !== t && "0" !== t && t
    }
    function z(t) {
        var e = Number(t);
        return !isNaN(e) && e
    ...
    function R(t) {
        return D(t) ? t : N(t) || I(t) ? t[0] : x(t) ? R(t[0]) : null
    }
    function F(t) {
        return D(t) ? [t] : N(t) ? g.slice.call(t) : x(t) ? t.map(R).filter(Boolean) : I(t) ? t.toArray() : []
    }
    function q(t) {
        return S(t) ? t : (t = R(t)) ? (L(t) ? t : t.ownerDocument).defaultView : window
    }
    function Y(t) {
        return x(t) ? t : M(t) ? t.split(/,(?![^(]*\))/).map(function(t) {
            return H(t) ? z(t) : j(t.trim())
        }) : [t]
    }
    function X(t) {
        return t ? c(t, "ms") ? W(t) : 1e3 * W(t) : 0
    }
    function V(t, i) {
        return t === i || k(t) && k(i) && Object.keys(t).length === Object.keys(i).length && K(t, function(t, e) {
            return t === i[e]
        })
    }
    function U(t, e, i) {
    ...
    var ct = "undefined" != typeof window
      ...
      , _t = ft ? "pointercancel" : "touchcancel";
    function bt(t, e) {
        return R(t) || kt(t, Ct(t, e))
    }
    function xt(t, e) {
        var i = F(t);
        return i.length && i || Et(t, Ct(t, e))
    }
    function Ct(t, e) {
        return void 0 === e && (e = document),
        It(t) || L(e) ? e : e.ownerDocument
    }
    function kt(t, e) {
        return R(Tt(t, e, "querySelector"))
    }
    function Et(t, e) {
        return F(Tt(t, e, "querySelectorAll"))
    }
    function Tt(t, s, e) {
        ...
        !t || !M(t))
            return null;
        var a;
        It(t = t.replace(Lt, "$1 *")) && (a = [],
        t = t.match(Dt).map(function(t) {
    ...
    var St = /(^|[^\\],)\s*[!>+~-]/
      , Lt = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g;
    function It(t) {
        return M(t) && t.match(St)
    }
    var Dt = /.*?[^\\](?:,|$)/g
      , At = ct ? Element.prototype : {}
      , Nt = At.matches || At.webkitMatchesSelector || At.msMatchesSelector || et;
    function $t(t, e) {
        return F(t).some(function(t) {
            return Nt.call(t, e)
        })
    }
    var Mt = At.closest || function(t) {
        var e = this;
        do {
            if ($t(e, t))
                return e
    ...
    function Ot(t, e) {
        ...
        A(t) ? Mt.call(t, e) : F(t).map(function(t) {
            return Ot(t, e)
        }).filter(Boolean)
    }
    function Ht(t) {
    ...
    var Pt = ct && window.CSS && CSS.escape || function(t) {
    ...
    function zt(t) {
        return F(t).some(function(t) {
            return jt[t.tagName.toLowerCase()]
        })
    }
    function Wt(t) {
        return F(t).some(function(t) {
    ...
    function Yt(t, e) {
        return M(e) ? $t(t, e) || !!Ot(t, e) : t === e || (L(e) ? e.documentElement : R(e)).contains(R(t))
    }
    function Xt(t, e) {
        for (var i = []; t = Ht(t); )
            e && !$t(t, e) || i.push(t);
    ...
    function Vt(t, e) {
        var i = (t = R(t)) ? F(t.children) : [];
        return e ? qt(i, e) : i
    }
    function Ut() {
        for (var t = [], e = arguments.length; e--; )
            t[e] = arguments[e];
        var i, n, r = Jt(t), o = r[0], s = r[1], a = r[2], l = r[3], c = r[4];
        o = ne(o);
        return 1 < l.length && (i = l,
        l = function(t) {
            return x(t.detail) ? i.apply(void 0, [t].concat(t.detail)) : i(t)
        }
        ),
        c && c.self && (n = l,
        l = function(t) {
        ...
        a && (l = function(t, n, r) {
            ...
            return function(i) {
                t.forEach(function(t) {
                    var e = ">" === n[0] ? Et(n, t).reverse().filter(function(t) {
    ...
    function Kt(t, i, n) {
        return ne(t).reduce(function(t, e) {
            return t && e.dispatchEvent(Gt(i, !0, !0, n))
        }, !0)
    }
    function Gt(t, e, i, n) {
        var r;
        return void 0 === e && (e = !0),
        void 0 === i && (i = !1),
        M(t) && ((r = document.createEvent("CustomEvent")).initCustomEvent(t, e, i, n),
        t = r),
        t
    }
    function Jt(t) {
    ...
    function ne(t) {
        return x(t) ? t.map(ie).filter(Boolean) : M(t) ? Et(t) : ee(t) ? [t] : F(t)
    }
    function re(t) {
    ...
    ,
    he.all = function(o) {
        return new he(function(i, t) {
            var n = []
              , r = 0;
            0 === o.length && i(n);
            for (var e = 0; e < o.length; e += 1)
                he.resolve(o[e]).then(function(e) {
                    return function(t) {
                        n[e] = t,
                        (r += 1) === o.length && i(n)
                    }
    ...
    function de(s, a) {
        return new ae(function(t, e) {
            ...
            Ut(n, "load", function() {
                0 === n.status || 200 <= n.status && n.status < 300 || 304 === n.status ? ("json" === i.responseType && M(n.response) && (n = Z(function(t) {
                    var e = {};
                    for (var i in t)
                        e[i] = t[i];
                    return e
    ...
    function pe(t) {
        var e;
        "loading" === document.readyState ? e = Ut(document, "DOMContentLoaded", function() {
            e(),
            t()
        }) : t()
    }
    function ge(t, e) {
        return e ? F(t).indexOf(R(e)) : Vt(Ht(t)).indexOf(t)
    }
    function me(t, e, i, n) {
        void 0 === i && (i = 0),
        void 0 === n && (n = !1);
        var r = (e = F(e)).length;
        return t = H(t) ? z(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : ge(e, t),
    ...
    function we(t, e) {
        return t = Ae(t),
        B(e) ? t.innerHTML : ye(t.hasChildNodes() ? ve(t) : t, e)
    }
    function ye(e, t) {
        return e = Ae(e),
        xe(t, function(t) {
    ...
    function be(e, t) {
        return e = Ae(e),
        xe(t, function(t) {
            return e.nextSibling ? _e(e.nextSibling, t) : ye(e.parentNode, t)
        })
    }
    function xe(t, e) {
    ...
    function Ee(t, e) {
        return F(F(t).map(function(t) {
            return t.hasChildNodes ? ke(F(t.childNodes), e) : ye(t, e)
        }))
    }
    function Te(t) {
        F(t).map(Ht).filter(function(t, e, i) {
            ...
            if (o.state !== le)
                for (; o.deferred.length; ) {
                    var t = o.deferred.shift()
                      ...
                      , r = t[3];
                    try {
                        0 === o.state ? C(e) ? n(e.call(void 0, o.value)) : n(o.value) : 1 === o.state && (C(i) ? n(i.call(void 0, o.value)) : r(o.value))
                    } catch (t) {
                        r(t)
                    }
                }
    ...
    function Ie(t) {
        ...
        return Se.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t,
    ...
    function Ae(t, e) {
        return M(t) ? $e(t) ? R(Ie(t)) : kt(t, e) : R(t)
    }
    function Ne(t, e) {
        return M(t) ? $e(t) ? F(Ie(t)) : Et(t, e) : F(t)
    }
    function $e(t) {
    ...
    function je(t) {
        for (var n, r = [], e = arguments.length - 1; 0 < e--; )
            r[e] = arguments[e + 1];
        r.length && (n = M(Q(r = We(r))) ? [] : r.pop(),
        r = r.filter(Boolean),
        F(t).forEach(function(t) {
            for (var e = t.classList, i = 0; i < r.length; i++)
                Re.Force ? e.toggle.apply(e, [r[i]].concat(n)) : e[(B(n) ? !e.contains(r[i]) : n) ? "add" : "remove"](r[i])
        }))
    }
    function ze(t, i, n) {
        (i = We(i).filter(Boolean)).length && F(t).forEach(function(t) {
            var e = t.classList;
            Re.Multiple ? e[n].apply(e, i) : i.forEach(function(t) {
                return e[n](t)
            })
        })
    }
    function We(t) {
        return t.reduce(function(t, e) {
            return t.concat.call(t, M(e) && y(e, " ") ? e.trim().split(" ") : e)
        }, [])
    }
    var Re = {
        get Multiple() {
        ...
        get: function(t) {
            var e;
            return u(this, t) || ((e = document.createElement("_").classList).add("a", "b"),
            e.toggle("c", !1),
    ...
    function qe(t, e, r) {
        return F(t).map(function(i) {
            if (M(e)) {
                ...
                B(r))
                    return Xe(i, e);
                r || O(r) ? i.style[e] = H(r) && !Fe[e] ? r + "px" : r : i.style.removeProperty(e)
            } else {
                if (x(e)) {
                    var n = Ye(i);
    ...
    function Ye(t, e) {
        return (t = R(t)).ownerDocument.defaultView.getComputedStyle(t, e)
    }
    function Xe(t, e, i) {
        return Ye(t, i)[e]
    }
    ...
    function Ue(t) {
        ...
        return ht ? (t in Ve || (Me(e = ye(i, document.createElement("div")), "uk-" + t),
        Ve[t] = Xe(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
        Ce(e)),
        Ve[t]) : Ye(i).getPropertyValue("--uk-" + t)
    }
    var Ze = {};
    function Qe(t) {
    ...
    function ei(t, e, s, a, l) {
        ...
        ae.all(F(t).map(function(o) {
            return new ae(function(i, n) {
                ...
                Qt(o, "animationend animationcanceled", function(t) {
                    var e = t.type;
                    clearTimeout(r),
                    ("animationcanceled" === e ? n : i)(),
                    qe(o, "animationDuration", ""),
                    He(o, ti + "\\S*")
                }, {
                    self: !0
                }),
                qe(o, "animationDuration", s + "ms"),
                Me(o, e, ti + (l ? "leave" : "enter")),
                w(e, ti) && Me(o, a && "uk-transform-origin-" + a, l && ti + "reverse")
            }
            )
        }))
    }
    ...
    function si(i, n) {
        ...
        ["left", "top"].forEach(function(t) {
            var e;
            t in n && (e = qe(i, t),
            qe(i, t, n[t] - r[t] + W("absolute" === o && "auto" === e ? li(i)[t] : e)))
        })
    }
    function ai(t) {
        if (!t)
            return {};
        var e, i, n = q(t), r = n.pageYOffset, o = n.pageXOffset;
        if (S(t)) {
            var s = t.innerHeight
              , a = t.innerWidth;
            return {
        ...
        Wt(t) || "none" !== qe(t, "display") || (e = ot(t, "style"),
        i = ot(t, "hidden"),
        ot(t, {
            style: (e || "") + ";display:block !important;",
            hidden: null
        }));
        var l = (t = R(t)).getBoundingClientRect();
        return B(e) || ot(t, {
            style: e,
            hidden: i
        }),
    ...
    function li(t, e) {
        e = e || (R(t) || {}).offsetParent || q(t).document.documentElement;
        var i = si(t)
          , n = si(e);
        return {
            top: i.top - n.top - W(qe(e, "borderTopWidth")),
            left: i.left - n.left - W(qe(e, "borderLeftWidth"))
        }
    }
    function ci(t) {
        var e = [0, 0];
    ...
    function di(n) {
        ...
        return function(t, e) {
            if (B(e)) {
                ...
                return (e = "auto" === (e = qe(t = R(t), n)) ? t["offset" + r] : W(e) || 0) - fi(t, n)
            }
            qe(t, n, e || 0 === e ? +e + fi(t, n) + "px" : "")
        }
    }
    function fi(i, t, e) {
        return void 0 === e && (e = "border-box"),
        qe(i, "boxSizing") === e ? ri[t].slice(1).map(p).reduce(function(t, e) {
            return t + W(qe(i, "padding" + e)) + W(qe(i, "border" + e + "Width"))
        }, 0) : 0
    }
    function pi(o, s, a, l) {
        K(ri, function(t, e) {
    ...
    function mi(t, e, i) {
        var n = (t || "").split(" ")
          ...
          , o = n[1];
        return {
            x: r ? W(r) * (c(r, "%") ? e / 100 : 1) : 0,
            y: o ? W(o) * (c(o, "%") ? i / 100 : 1) : 0
        }
    }
    function vi(t) {
        switch (t) {
    ...
    function wi(t, e, i) {
        ...
        void 0 === i && (i = window),
        H(t) ? +t : c(t, "vh") ? yi(hi(q(i)), t) : c(t, "vw") ? yi(ui(q(i)), t) : c(t, "%") ? yi(ai(i)[e], t) : W(t)
    }
    function yi(t, e) {
        return t * W(e) / 100
    }
    var _i = {
        ...
        clear: function(t) {
            return Ei(this.reads, t) || Ei(this.writes, t)
        },
        flush: bi
    };
    function bi(t) {
        void 0 === t && (t = 1),
        ki(_i.reads),
        ki(_i.writes.splice(0, _i.writes.length)),
        _i.scheduled = !1,
        (_i.reads.length || _i.writes.length) && Ci(t + 1)
    }
    var xi = 4;
    function Ci(t) {
        _i.scheduled || (_i.scheduled = !0,
        t && t < xi ? ae.resolve().then(function() {
            return bi(t)
    ...
    function Ai(t, e) {
        ...
        void 0 === e && (e = []);
        try {
            return t ? w(t, "{") ? JSON.parse(t) : e.length && !y(t, ":") ? ((i = {})[e[0]] = t,
            i) : t.split(";").reduce(function(t, e) {
                var i = e.split(/:(.*)/)
                  , n = i[0]
                  , r = i[1];
                return n && !B(r) && (t[n.trim()] = r.trim()),
                t
            }, {}) : {}
        } catch (t) {
            return {}
    ...
    Si.events = Si.created = Si.beforeConnect = Si.connected = Si.beforeDisconnect = Si.disconnected = Si.destroy = Ii,
    ...
    ,
    Si.data = function(e, i, t) {
        return t ? Li(e, i, t) : i ? e ? function(t) {
            return Li(e, i, t)
        }
        : i : e
    }
    ...
    function Pi(t, e) {
        ...
        if (void 0 === h && (h = 0),
        Wt(t)) {
            for (var u = Wi(t).concat(t), i = ae.resolve(), n = function(c) {
                i = i.then(function() {
                    return new ae(function(i) {
                        var t, n = u[c], e = u[c + 1], r = n.scrollTop, o = Math.ceil(li(e, zi(n)).top - h), s = (t = Math.abs(o),
                        40 * Math.pow(t, .375)), a = Date.now(), l = function() {
                            var t, e = (t = tt((Date.now() - a) / s),
                            .5 * (1 - Math.cos(Math.PI * t)));
                            Hi(n, r + o * e),
                            1 != e ? requestAnimationFrame(l) : i()
                        };
                        l()
                    }
                    )
    ...
    function ji(t, e) {
        ...
        var i = Ri(t)
          , n = Xt(t).filter(function(t) {
            return t === i || e.test(qe(t, "overflow")) && t.scrollHeight > Math.round(si(t).height)
        }).reverse();
        return n.length ? n : [i]
    }
    function zi(t) {
    ...
    function Wi(t) {
        return ji(t, /auto|scroll|hidden/)
    }
    function Ri(t) {
        var e = q(t).document;
    ...
    Ni.prototype.enableApi = function() {
        ...
        return r || o ? this.ready = new ae(function(t) {
            ...
            ,
            new ae(function(i) {
                return Qt(window, "message", function(t, e) {
                    return i(e)
                }, !1, function(t) {
                    var e = t.data;
                    try {
    ...
    ;
    var Fi, qi, Yi, Xi, Vi, Ui, Zi, Qi, Ki, Gi = ct && window.IntersectionObserver || (Ji.prototype.takeRecords = function() {
        var i = this;
        return this.targets.filter(function(t) {
            var e = Oi(t.target, i.offsetTop, i.offsetLeft);
    ...
    ,
    Ji.prototype.observe = function(t) {
        this.targets.push({
            target: t,
            isIntersecting: null
        }),
    ...
    function Ji(e, t) {
        ...
        void 0 === n && (n = "0 0"),
        this.targets = [];
        var r, o = (n || "0 0").split(" ").map(W), s = o[0], a = o[1];
        this.offsetTop = s,
        this.offsetLeft = a,
        this.apply = function() {
    ...
    function rn(t, e) {
        ...
        for (var s in r) {
            var a = d(s)
              , l = lt(o, a);
            B(l) || (l = r[s] === Boolean && "" === l || sn(r[s], l),
            ("target" !== a || l && !w(l, "_")) && (i[s] = l))
        }
        var c = Ai(lt(o, e), n);
        for (var h in c) {
            var u = f(h);
            void 0 !== r[u] && (i[u] = sn(r[u], c[h]))
        }
        return i
    }
    function on(e, i, n) {
        ...
        x(r) ? r.forEach(function(t) {
            return on(e, Z({}, i, {
                el: t
            }), n)
        }) : !r || c && !c.call(e) || e._events.push(Ut(r, t, l ? M(l) ? l : l.call(e) : null, M(o) ? e[o] : o.bind(e), {
            passive: a,
            capture: s,
            self: h
        }))
    ...
    function sn(t, e) {
        return t === Boolean ? j(e) : t === Number ? z(e) : "list" === t ? Y(e) : t ? t(e) : e
    }
    en.util = Object.freeze({
        __proto__: null,
        ajax: de,
        getImage: fe,
        transition: Ge,
        ...
        prepend: function(e, t) {
            return (e = Ae(e)).hasChildNodes() ? xe(t, function(t) {
    ...
    Fi.mixin = function(t, e) {
        (e = (M(e) ? Fi.component(e) : e) || this).options = Di(e.options, t)
    }
    ,
    Fi.extend = function(t) {
        ...
        return t = t || {},
        ((e.prototype = Object.create(this.prototype)).constructor = e).options = Di(this.options, t),
        e.super = this,
    ...
    Fi.update = function(t, e) {
        Xt(t = t ? R(t) : document.body).reverse().forEach(function(t) {
            return nn(t[Yi], e)
        }),
        De(t, function(t) {
            return nn(t[Yi], e)
    ...
    (Xi = en).prototype._callHook = function(t) {
        var e = this
          , i = this.$options[t];
    ...
    ,
    Xi.prototype._callConnected = function() {
    ...
    ,
    Xi.prototype._callDisconnected = function() {
    ...
    ,
    Xi.prototype._callUpdate = function(t) {
        var o = this;
        void 0 === t && (t = "update");
        var s = t.type || t;
        ...
        e && e.forEach(function(t, e) {
            var i = t.read
              , n = t.write
              , r = t.events;
            "update" !== s && !y(r, s) || (i && !y(_i.reads, a[e]) && (a[e] = _i.read(function() {
                var t = o._connected && i.call(o, o._data, s);
                !1 === t && n ? _i.clear(l[e]) : T(t) && Z(o._data, t)
            })),
            n && !y(_i.writes, l[e]) && (l[e] = _i.write(function() {
                return o._connected && n.call(o, o._data, s)
            })))
        })
    }
    ,
    Xi.prototype._callWatches = function() {
        var l, c = this, h = this._frames;
        h._watch || (l = !u(h, "_watch"),
        h._watch = _i.read(function() {
            if (c._connected) {
                var t = c.$options.computed
                  , e = c._computeds;
                for (var i in t) {
                    var n = u(e, i)
                      , r = e[i];
                    ...
                    var o = t[i]
                      , s = o.watch
                      , a = o.immediate;
                    s && (l && a || n && !V(r, c[i])) && s.call(c, c[i], r)
                }
                h._watch = null
            }
        }))
    ...
    ,
    Ui = 0,
    (Vi = en).prototype._init = function(t) {
        (t = t || {}).data = function(t, e) {
            ...
            e.args)
              , r = e.props;
            if (void 0 === r && (r = {}),
            i = x(i) ? P(n) ? void 0 : i.slice(0, n.length).reduce(function(t, e, i) {
                return T(e) ? Z(t, e) : t[n[i]] = e,
                t
            }, {}) : i)
                for (var o in i)
                    B(i[o]) ? delete i[o] : i[o] = r[o] ? sn(r[o], i[o]) : i[o];
            return i
        }(t, this.constructor.options),
        this.$options = Di(this.constructor.options, t, this),
        this.$el = null,
        this.$props = {},
        this._uid = Ui++,
        this._initData(),
    ...
    ,
    Vi.prototype._initData = function() {
    ...
    ,
    Vi.prototype._initMethods = function() {
    ...
    ,
    Vi.prototype._initComputeds = function() {
                    ...
                    Object.defineProperty(n, r, {
                        ...
                        get: function() {
                            var t = n._computeds
                              , e = n.$props
                              , i = n.$el;
                            return u(t, r) || (t[r] = (o.get || o).call(n, e, i)),
                            t[r]
                        },
                        set: function(t) {
                            var e = n._computeds;
    ...
    ,
    Vi.prototype._initProps = function(t) {
        var e;
        for (e in t = t || rn(this.$options, this.$name))
        ...
        for (e in this.$props)
            ...
            }(0, e) && (this[e] = this.$props[e])
    }
    ,
    Vi.prototype._initEvents = function() {
        var i = this;
        this._events = [];
    ...
    ,
    Vi.prototype._unbindEvents = function() {
    ...
    ,
    Vi.prototype._initObserver = function() {
        var t, r = this, e = this.$options, o = e.attrs, i = e.props, n = e.el;
        !this._observer && i && !1 !== o && (o = x(o) ? o : Object.keys(i),
        this._observer = new MutationObserver(function(t) {
            var n = rn(r.$options, r.$name);
            t.some(function(t) {
                var e = t.attributeName
                  , i = e.replace("data-", "");
                return (i === r.$name ? o : [f(i), f(e)]).some(function(t) {
                    return !B(n[t]) && n[t] !== r.$props[t]
                })
            }) && r.$reset()
        }
        ),
    ...
    Zi.component = function(s, t) {
        ...
        if (s = f(e),
        !t)
            return T(Ki[s]) && (Ki[s] = Zi.extend(Ki[s])),
            Ki[s];
        Zi[s] = function(t, i) {
        ...
        ;
        var i = T(t) ? Z({}, t) : t.options;
        return i.name = s,
        i.install && i.install(Zi, i, s),
        Zi._initialized && !i.functional && _i.read(function() {
    ...
    var an = {
        connected: function() {
            Be(this.$el, this.$name) || Me(this.$el, this.$name)
        }
    }
      , ln = {
        props: {
        ...
        methods: {
            toggleElement: function(t, i, n) {
                var r = this;
                return ae.all(F(t).map(function(e) {
            ...
            isToggled: function(t) {
                var e = F(t || this.$el);
                return this.cls ? Be(e, this.cls.split(" ")[0]) : !st(e, "hidden")
            },
            ...
            _toggleElement: function(t, e, i) {
                var n = this;
                if (e = $(e) ? e : ni.inProgress(t) ? Be(t, "uk-animation-leave") : Je.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t),
                !Kt(t, "before" + (e ? "show" : "hide"), [this]))
                    return ae.reject();
                var o, r = (C(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? cn(this) : (o = this,
                function(t, e) {
                    ni.cancel(t);
                    var i = o.animation
                      , n = o.duration
                ...
                return Kt(t, e ? "show" : "hide", [this]),
                (r || ae.resolve()).then(function() {
            ...
            _toggle: function(t, e) {
                var i;
                t && (e = Boolean(e),
                this.cls ? (i = y(this.cls, " ") || e !== Be(t, this.cls)) && je(t, this.cls, y(this.cls, " ") ? void 0 : e) : (i = e === st(t, "hidden")) && ot(t, "hidden", e ? null : ""),
    ...
    function cn(t) {
        var s = t.isToggled
          ...
          , u = t._toggle;
        return function(t, e) {
            var i = Je.inProgress(t)
              , n = t.hasChildNodes ? W(qe(t.firstElementChild, "marginTop")) + W(qe(t.lastElementChild, "marginBottom")) : 0
              , r = Wt(t) ? hi(t) + (i ? 0 : n) : 0;
            Je.cancel(t),
            s(t) || u(t, !0),
            hi(t, ""),
    ...
    var hn = {
        ...
        computed: {
            items: {
                ...
                watch: function(t, e) {
                    var i, n = this;
                    t.forEach(function(t) {
                        return un(Ae(n.content, t), !Be(t, n.clsOpen))
                    }),
                    e || Be(t, this.clsOpen) || (i = !1 !== this.active && t[Number(this.active)] || !this.collapsible && t[0]) && this.toggle(i, !1)
                },
                immediate: !0
            }
        },
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(),
                this.toggle(ge(Ne(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        methods: {
            toggle: function(t, r) {
                var o = this
                  ...
                  , i = qt(this.items, "." + this.clsOpen);
                this.multiple || y(i, e[0]) || (e = e.concat(i)),
                !this.collapsible && i.length < 2 && !qt(e, ":not(." + this.clsOpen + ")").length || e.forEach(function(t) {
                    return o.toggleElement(t, !Be(t, o.clsOpen), function(e, i) {
                        je(e, o.clsOpen, i);
                        var n = Ae((e._wrapper ? "> * " : "") + o.content, e);
                        if (!1 !== r && o.hasTransition)
                            return e._wrapper || (e._wrapper = ke(n, "<div" + (i ? " hidden" : "") + ">")),
                            un(n, !1),
                            cn(o)(e._wrapper, i).then(function() {
                                ...
                                delete e._wrapper,
                                Te(n),
                                i && (Oi(t = Ae(o.$props.toggle, e)) || Pi(t, {
                                    offset: o.offset
                                }))
                            });
                        un(n, !i)
    ...
    var dn, fn = {
        ...
        update: {
            read: function() {
                return !!this.player && {
                    visible: Wt(this.$el) && "hidden" !== qe(this.$el, "visibility"),
        ...
        methods: {
            positionAt: function(t, e, i) {
                var n;
                He(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?");
                var r = this.offset
                  , o = this.getAxis();
                H(r) || (r = (n = Ae(r)) ? si(n)["x" === o ? "left" : "top"] - si(e)["x" === o ? "right" : "bottom"] : 0);
                ...
                this.dir = "x" === o ? a : l,
                this.align = "x" === o ? l : a,
                je(t, this.clsPos + "-" + this.dir + "-" + this.align, !1 === this.offset)
            },
            getAxis: function() {
        ...
        connected: function() {
            ...
            this.toggle = t && this.$create("toggle", bt(t, this.$el), {
                target: this.$el,
                mode: this.mode
            }),
        ...
        events: [{
            ...
            handler: function() {
                var o = this;
                (dn = this).tracker.init(),
                Kt(this.$el, "updatearia"),
                Qt(this.$el, "hide", Ut(document, gt, function(t) {
                    var r = t.target;
                    return !Yt(r, o.$el) && Qt(document, vt + " " + _t + " scroll", function(t) {
                        var e = t.defaultPrevented
                          , i = t.type
                          , n = t.target;
                        e || i !== vt || r !== n || o.toggle && Yt(r, o.toggle.$el) || o.hide(!1)
                    }, !0)
                }), {
                    self: !0
                }),
                Qt(this.$el, "hide", Ut(document, "keydown", function(t) {
            ...
            handler: function(t) {
                var e = t.target;
                this.$el === e ? (dn = this.isActive() ? null : dn,
                Kt(this.$el, "updatearia"),
                this.tracker.cancel()) : dn = null === dn && Yt(e, this.$el) && this.isToggled() ? this : dn
            }
        }, {
            name: "updatearia",
            self: !0,
            handler: function(t, e) {
                ...
                je(this.toggle.$el, this.cls, this.isToggled()))
            }
        }],
        update: {
            write: function() {
        ...
        methods: {
            ...
            hide: function(t) {
                ...
                i = [],
                De(e, function(t) {
                    return "static" !== qe(t, "position") && i.push(t)
                }),
                i.some(function(t) {
            ...
            position: function() {
                ...
                qe(this.$el, t, i[t])) : this.$el.offsetWidth > Math.max(e.right - i.left, i.right - e.left) && Me(this.$el, this.clsDrop + "-stack"),
        ...
        update: function() {
            ...
            !n || n[e = Ft(n) ? "value" : "textContent"] !== (i = r.files && r.files[0] ? r.files[0].name : $t(r, "select") && (t = Ne("option", r).filter(function(t) {
                return t.selected
        ...
        update: {
            read: function() {
                var i, t = bn(this.$el.children);
                return {
                    rows: t,
                    columns: (i = [[]],
                    t.forEach(function(t) {
                        return xn(t, "left", "right").forEach(function(t, e) {
    ...
    function xn(t, e, i) {
        for (var n = [[]], r = 0; r < t.length; r++) {
            var o = t[r];
            if (Wt(o))
                for (var s = Cn(o), a = n.length - 1; 0 <= a; a--) {
                    var l = n[a];
                    if (!l[0]) {
                        l.push(o);
                        break
                    }
                    var c = l[0].offsetParent === o.offsetParent ? Cn(l[0]) : (s = Cn(o, !0),
                    Cn(l[0], !0));
    ...
    var kn = {
        ...
        update: [{
            ...
            read: function(t) {
                ...
                if (!n.length || !this.masonry && !this.parallax)
                    return !1;
                var r, o, s, a, l, c = n.some(Je.inProgress), h = !1, u = e.map(function(t) {
                    return t.reduce(function(t, e) {
                        return t + e.offsetHeight
                    }, 0)
                }), d = (r = n,
                o = this.margin,
                W((s = r.filter(function(t) {
                    return Be(t, o)
                })[0]) ? qe(s, "marginTop") : qe(r[0], "paddingLeft")) * (i.length - 1)), f = Math.max.apply(Math, u) + d;
                this.masonry && (a = e = e.map(function(t) {
                ...
                h = a.map(function(i) {
                    ...
                    return i.map(function(t, e) {
                        return n += e ? l[e - 1] - i[e - 1].offsetHeight : 0
                    })
                }));
                var p = Math.abs(this.parallax);
                return {
                    padding: p = p && u.reduce(function(t, e, i) {
            ...
            read: function(t) {
                var e = t.height;
                return {
                    scrolled: !!this.parallax && Bi(this.$el, e ? e - hi(this.$el) : 0) * Math.abs(this.parallax)
                }
            },
            write: function(t) {
                var e = t.columns
                ...
                !1 === n && !r || e.forEach(function(t, i) {
                    return t.forEach(function(t, e) {
                        return qe(t, "transform", n || r ? "translateY(" + ((r && -r[i][e]) + (n ? i % 2 ? n : n / 8 : 0)) + "px)" : "")
                    })
                })
            },
            events: ["scroll", "resize"]
        ...
        update: [{
            ...
            write: function() {
                ...
                this.elements.forEach(function(t) {
                    var e = W(qe(t, "minHeight"));
                    e && (i.forceHeight || Math.round(e + fi(t, "height", "content-box")) >= t.offsetHeight) && qe(t, "height", e)
                })
            },
            order: 5,
            events: ["resize"]
      ...
      , Tn = {
        ...
        update: {
            read: function() {
                return {
                    rows: (this.row ? bn(this.elements) : [this.elements]).map(Sn)
                }
            },
            write: function(t) {
    ...
    function Sn(t) {
        ...
        return o && s && (qe(t, "minHeight", ""),
        e = Ln(t),
        n = e.heights,
        r = e.max),
        {
            heights: n = t.map(function(t, e) {
                return n[e] === r && W(t.style.minHeight).toFixed(2) !== r.toFixed(2) ? "" : r
            }),
            elements: t
        }
    }
    ...
    var In = {
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    Ae("[data-height-expand]") !== this.$el)
                        return !1;
                    i = hi(window) - (Dn(document.documentElement) - Dn(this.$el)) - n || ""
                } else {
                    var r;
                    i = "calc(100vh";
                    this.offsetTop && (i += 0 < (r = si(this.$el).top) && r < hi(window) / 2 ? " - " + r + "px" : ""),
                    !0 === this.offsetBottom ? i += " - " + Dn(this.$el.nextElementSibling) + "px" : H(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && c(this.offsetBottom, "px") ? i += " - " + W(this.offsetBottom) + "px" : M(this.offsetBottom) && (i += " - " + Dn(bt(this.offsetBottom, this.$el)) + "px"),
                    i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
            ...
            write: function(t) {
                ...
                this.minHeight && W(qe(this.$el, "minHeight")) < this.minHeight && qe(this.$el, "minHeight", this.minHeight)
            },
            events: ["resize"]
        }
    };
    ...
    var An = {
        ...
        connected: function() {
            var t, e = this;
            !this.icon && y(this.src, "#") && (t = this.src.split("#"),
            this.src = t[0],
            this.icon = t[1]),
        ...
        disconnected: function() {
            var e = this;
            zt(this.$el) && ot(this.$el, "hidden", null),
        ...
        update: {
            ...
            write: function() {
                var t, e;
                (e = On(t = this.svgEl)) && t.style.setProperty("--uk-animation-stroke", e)
            },
            type: ["resize"]
        },
        methods: {
            getSvg: function() {
                var i, n = this;
                return (i = this.src,
                Nn[i] ? Nn[i] : Nn[i] = new ae(function(e, t) {
                    ...
                    return e = t,
                    (i = n.icon) && y(e, "<symbol") && (e = function(t, e) {
                        var i;
                        if (!Mn[t])
                            for (Mn[t] = {},
                            $n.lastIndex = 0; i = $n.exec(t); )
                                Mn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                        return Mn[t][e]
                    }(e, i) || e),
                    (e = Ae(e.substr(e.indexOf("<svg")))) && e.hasChildNodes() && e || ae.reject("SVG not found.");
                    var e, i
                })
            },
            applyAttributes: function(i) {
                ...
                for (var t in this.$options.props)
                    this[t] && y(this.include, t) && ot(i, t, this[t]);
    ...
    var Pn = {
      ...
      , Bn = {
        install: function(r) {
            r.icon.add = function(t, e) {
                ...
                r._initialized && De(document.body, function(t) {
        ...
        methods: {
            getSvg: function() {
                var t, e, i = (t = this.icon,
                Pn[t] ? (qn[t] || (qn[t] = Ae((Pn[(e = t,
                ut ? U(U(e, "left", "right"), "previous", "next") : e)] || Pn[t]).trim())),
                qn[t].cloneNode(!0)) : null);
                return i ? ae.resolve(i) : ae.reject("Icon not found.")
            }
        }
    }
      , jn = {
      ...
      , Wn = {
        ...
        computed: {
            icon: function(t, e) {
                var i = t.icon;
                return Be(e, "uk-search-icon") && Xt(e, ".uk-search-large").length ? "search-large" : Xt(e, ".uk-search-navbar").length ? "search-navbar" : i
            }
        }
    }
      , Rn = {
      ...
      , Fn = {
        ...
        connected: function() {
            ...
            this.svg.then(function(t) {
                return 1 !== e.ratio && qe(Ae("circle", t), "strokeWidth", 1 / e.ratio)
            }, et)
        }
    }
      , qn = {}
      , Yn = {
        ...
        connected: function() {
            var t, e, i, n;
            tr[this.cacheKey] ? Xn(this.$el, tr[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && Xn(this.$el, (t = this.width,
            e = this.height,
            (i = this.sizes) && (t = (n = rt.ratio({
                width: t,
                height: e
            }, "width", wi(Un(i)))).width,
            e = n.height),
        ...
        update: {
            read: function(t) {
                ...
                this.isImg)
                    return !1;
                i && i.then(function(t) {
                    return t && "" !== t.currentSrc && Xn(e.$el, Jn(t))
                })
            },
            write: function(t) {
                var e, i, n, r, o;
                this.dataSrcset && 1 !== window.devicePixelRatio && (!(e = qe(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && W(e) !== t.bgSize || (t.bgSize = (i = this.dataSrcset,
                n = this.sizes,
                r = wi(Un(n)),
                (o = (i.match(Kn) || []).map(W).sort(function(t, e) {
                    return t - e
                })).filter(function(t) {
                    return r <= t
                })[0] || o.pop() || ""),
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return Xn(e.$el, Jn(t), t.srcset, t.sizes),
                    tr[e.cacheKey] = Jn(t),
                    t
                }, function(t) {
    ...
    function Xn(t, e, i, n) {
        Gn(t) ? (n && (t.sizes = n),
        i && (t.srcset = i),
        e && (t.src = e)) : e && !y(t.style.backgroundImage, e) && (qe(t, "backgroundImage", "url(" + Bt(e) + ")"),
        Kt(t, Gt("load", !1)))
    }
    ...
    function Un(t) {
        ...
        for (Vn.lastIndex = 0; e = Vn.exec(t); )
            if (!e[1] || window.matchMedia(e[1]).matches) {
                e = w(i = e[2], "calc") ? i.substring(5, i.length - 1).replace(Zn, function(t) {
                    return wi(t)
                }).replace(/ /g, "").match(Qn).reduce(function(t, e) {
                    return t + +e
                }, 0) : i;
                break
            }
      ...
      , sr = {
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                this.isToggled() === y(or, this) && this.toggle())
            }
        }, {
            name: "beforeshow",
            self: !0,
            handler: function(t) {
                if (y(or, this))
                    return !1;
                !this.stack && or.length ? (ae.all(or.map(function(t) {
                    return t.hide()
                })).then(this.show),
            ...
            handler: function() {
                var o = this;
                ui(window) - ui(document) && this.overlay && qe(document.body, "overflowY", "scroll"),
                this.stack && qe(this.$el, "zIndex", qe(this.$el, "zIndex") + or.length),
                Me(document.documentElement, this.clsPage),
                this.bgClose && Qt(this.$el, "hide", Ut(document, gt, function(t) {
                    var r = t.target;
                    Q(or) !== o || o.overlay && !Yt(r, o.$el) || Yt(r, o.panel) || Qt(document, vt + " " + _t + " scroll", function(t) {
                        var e = t.defaultPrevented
                          , i = t.type
                          , n = t.target;
                        e || i !== vt || r !== n || o.hide()
                ...
                this.escClose && Qt(this.$el, "hide", Ut(document, "keydown", function(t) {
                    27 === t.keyCode && Q(or) === o && (t.preventDefault(),
                    o.hide())
                }), {
                    self: !0
                })
            ...
            handler: function() {
                ...
                or.length || qe(document.body, "overflowY", ""),
                qe(this.$el, "zIndex", ""),
                or.some(function(t) {
        ...
        methods: {
            ...
            show: function() {
                var e = this;
                return this.container && this.$el.parentNode !== this.container ? (ye(this.container, this.$el),
                new ae(function(t) {
            ...
            return new ae(function(i, n) {
                return Qt(r, "show hide", function() {
                    ...
                    var t = Qt(s, "transitionstart", function() {
                        Qt(s, "transitionend transitioncancel", i, {
                            self: !0
                        }),
                        clearTimeout(e)
                    }, {
    ...
    var lr = {
        install: function(t) {
            ...
            a.alert = function(i, t) {
                return e(function(t) {
                    var e = t.labels;
                    return '<div class="uk-modal-body">' + (M(i) ? i : we(i)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + e.ok + "</button> </div>"
                }, t, function(t) {
                    return t.resolve()
                })
            }
            ...
            a.confirm = function(i, t) {
                return e(function(t) {
                    var e = t.labels;
                    return '<form> <div class="uk-modal-body">' + (M(i) ? i : we(i)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">' + e.cancel + '</button> <button class="uk-button uk-button-primary" autofocus>' + e.ok + "</button> </div> </form>"
                }, t, function(t) {
                    return t.reject()
                })
            }
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Be(this.panel, "uk-margin-auto-vertical") ? Me(this.$el, "uk-flex") : qe(this.$el, "display", "block"),
                hi(this.$el)
            }
        }, {
            name: "hidden",
      ...
      , hr = {
        ...
        computed: {
            ...
            dropbar: {
                get: function(t) {
                    var e = t.dropbar;
                    return e ? (e = this._dropbar || bt(e, this.$el) || Ae("+ .uk-navbar-dropbar", this.$el)) || (this._dropbar = Ae("<div></div>")) : null
                },
                watch: function(t) {
        ...
        events: [{
            ...
            handler: function(t, e) {
                var i = e.$el
                  , n = e.dir;
                "slide" === this.dropbarMode && Me(this.dropbar, "uk-navbar-dropbar-slide"),
                this.clsDrop && Me(i, this.clsDrop + "-dropbar"),
                "bottom" === n && this.transitionTo(i.offsetHeight + W(qe(i, "marginTop")) + W(qe(i, "marginBottom")), i)
            }
        }, {
            name: "beforehide",
            filter: function() {
            ...
            handler: function(t, e) {
                var i = e.$el
                  , n = this.getActive();
                $t(this.dropbar, ":hover") && n && n.$el === i && t.preventDefault()
            }
        }, {
            name: "hide",
            filter: function() {
        ...
        methods: {
            getActive: function() {
                ...
                return t && y(t.mode, "hover") && Yt(t.toggle.$el, this.$el) && t
            },
            transitionTo: function(t, e) {
                var i = this
                  , n = this.dropbar
                  , r = Wt(n) ? hi(n) : 0;
                return qe(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"),
                hi(n, r),
                Je.cancel([e, n]),
                ae.all([Je.start(n, {
                    height: t
      ...
      , ur = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                "reveal" !== this.mode || Be(this.panel.parentNode, this.clsMode) || (ke(this.panel, "<div>"),
                ...
                Me(this.panel, this.clsSidebarAnimation, "reveal" !== this.mode ? this.clsMode : ""),
                hi(document.body),
    ...
    function dr() {
        return Ae('meta[name="viewport"]', document.head) || ye(document.head, '<meta name="viewport">')
    }
    var fr = {
        mixins: [an],
        props: {
        ...
        connected: function() {
            qe(this.$el, "minHeight", 150)
        },
        update: {
            read: function() {
                return !(!this.content || !this.container) && {
                    current: W(qe(this.$el, "maxHeight")),
                    max: Math.max(150, hi(this.container) - (si(this.content).height - hi(this.$el)))
                }
            },
            write: function(t) {
                var e = t.current
                  , i = t.max;
                qe(this.$el, "maxHeight", i),
      ...
      , gr = {
        ...
        methods: {
            scrollTo: function(t) {
                ...
                Kt(this.$el, "beforescroll", [this, t]) && Pi(t, {
                    offset: this.offset
                }).then(function() {
      ...
      , mr = {
        ...
        computed: {
            elements: {
                ...
                watch: function(t) {
                    this.hidden && qe(qt(t, ":not(." + this.inViewClass + ")"), "visibility", "hidden")
                },
                immediate: !0
            }
        },
        update: [{
            read: function(t) {
                ...
                t.update && this.elements.forEach(function(t) {
                    ...
                    (e = e || {
                        cls: lt(t, "uk-scrollspy-class") || i.cls
                    }).show = Oi(t, i.offsetTop, i.offsetLeft),
            ...
            write: function(n) {
                ...
                this.elements.forEach(function(e) {
                    function t(t) {
                        qe(e, "visibility", !t && r.hidden ? "hidden" : ""),
                        je(e, r.inViewClass, t),
                        je(e, i.cls),
      ...
      , vr = {
        ...
        update: [{
            ...
            write: function(t) {
                ...
                !1 !== e && Kt(this.$el, "active", [e, Me(this.elements[e], this.cls)])
            },
            events: ["scroll", "resize"]
        }]
    }
      , wr = {
        ...
        computed: {
            ...
            isActive: {
                ...
                set: function(t) {
                    ...
                    Kt(this.$el, "active")) : t || Be(this.selTarget, this.clsInactive) || (Pe(this.selTarget, this.clsActive, this.clsInactive),
                    Kt(this.$el, "inactive"))
                }
            }
        },
        ...
        events: [{
            ...
            handler: function() {
                var n, r = this;
                !1 !== this.targetOffset && location.hash && 0 < window.pageYOffset && (n = Ae(location.hash)) && _i.read(function() {
                    var t = si(n).top
                      , e = si(r.$el).top
                      , i = r.$el.offsetHeight;
                    r.isFixed && t <= e + i && e <= t + n.offsetHeight && Hi(window, t - i - (H(r.targetOffset) ? r.targetOffset : 0) - r.offset)
                })
            }
        }],
        update: [{
            read: function(t, e) {
                var i = t.height;
                if (this.inactive = !this.matchMedia || !Wt(this.$el),
                this.inactive)
                    return !1;
                ...
                var n = yr("bottom", this);
                return this.top = Math.max(W(yr("top", this)), this.topOffset) - this.offset,
                this.bottom = n && n - this.$el.offsetHeight,
                this.width = si(Wt(this.widthElement) ? this.widthElement : this.$el).width,
                {
                    height: i,
            ...
            write: function(t, e) {
                ...
                var o = t.dir
                  ...
                  , l = t.scroll
                  , c = t.top;
                if (!((t.lastScroll = l) < 0 || l === a && "scroll" === e || this.showOnUp && "scroll" !== e && !this.isFixed || ((300 < n - r || o !== s) && (t.initScroll = l,
                t.initTimestamp = n),
                t.lastDir = o,
                this.showOnUp && !this.isFixed && Math.abs(t.initScroll - l) <= 30 && Math.abs(a - l) <= 10)))
                    if (this.inactive || l < this.top || this.showOnUp && (l <= this.top || "down" === o && "scroll" === e || "up" === o && !this.isFixed && l <= this.bottomOffset)) {
                        if (!this.isFixed)
                            return void (ni.inProgress(this.$el) && l < c && (ni.cancel(this.$el),
                            this.hide()));
                        this.isFixed = !1,
                        this.animation && l > this.topOffset ? (ni.cancel(this.$el),
        ...
        methods: {
            ...
            update: function() {
                ...
                H(this.bottom) && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll),
                qe(this.$el, {
                    position: "fixed",
                    top: e + "px",
                    width: this.width
    ...
    function yr(t, e) {
        var i = e.$props
          ...
          , o = i[t];
        if (o)
            return M(o) && o.match(/^-?\d/) ? r + wi(o) : si(!0 === o ? n.parentNode : bt(o, n)).bottom
    }
    var _r, br, xr, Cr = {
        mixins: [ln],
        args: "connect",
        ...
        computed: {
            ...
            toggles: {
                get: function(t, e) {
                    return Ne(t.toggle, e).filter(function(t) {
                        return !$t(t, ".uk-disabled *, .uk-disabled, [disabled]")
                    })
                },
                watch: function(t) {
                    var e = this.index();
            ...
            children: function() {
                var t = this;
                return Vt(this.$el).filter(function(e) {
        ...
        events: [{
            ...
            handler: function(t) {
                y(this.toggles, t.current) && (t.preventDefault(),
                this.show(t.current))
            }
        }, {
            name: "click",
            ...
            handler: function(t) {
                t.preventDefault(),
                this.show(lt(t.current, this.attrItem))
            }
        }, {
        ...
        methods: {
            index: function() {
                var e = this;
                return b(this.children, function(t) {
                    return Be(t, e.cls)
                })
            },
            show: function(t) {
                ...
                this.connects.forEach(function(t) {
                    var e = t.children;
                    return i.toggleElement(F(e).filter(function(t, e) {
        ...
        events: [{
            ...
            handler: function(t) {
                var e;
                (Ot(t.target, 'a[href="#"], a[href=""]') || (e = Ot(t.target, "a[href]")) && (this.cls && !Be(this.target, this.cls.split(" ")[0]) || !Wt(this.target) || e.hash && $t(this.target, e.hash))) && t.preventDefault(),
                this.toggle()
            }
        }],
        update: {
    ...
    en.use(function(r) {
        ct && pe(function() {
            ...
            Ut(document, "animationstart", function(t) {
                var e = t.target;
                (qe(e, "animationName") || "").match(/^uk-.*(left|right)/) && (n++,
                qe(document.body, "overflowX", "hidden"),
                setTimeout(function() {
                    --n || qe(document.body, "overflowX", "")
                }, X(qe(e, "animationDuration")) + 100))
            }, !0),
            Ut(document, gt, function(t) {
                var s, a;
                i && i(),
                re(t) && (s = oe(t),
                a = "tagName"in t.target ? t.target : t.target.parentNode,
                i = Qt(document, vt + " " + _t, function(t) {
                    var e = oe(t)
                      , r = e.x
                      , o = e.y;
    ...
    br = (_r = en).connect,
    xr = _r.disconnect,
    ct && window.MutationObserver && _i.read(function() {
        document.body && De(document.body, br),
    ...
    var Tr, Sr = {
        ...
        methods: {
            animate: function(t, n) {
                var i = this;
                void 0 === n && (n = this.$el),
                Tr || (Tr = ye(document.head, "<style>").sheet).insertRule("." + Lr + " > * {\n            margin-top: 0 !important;\n            transform: none !important;\n        }", 0);
                var r = Vt(n)
                  , o = r.map(function(t) {
                    return Dr(t, !0)
                })
                ...
                _i.flush();
                var a = hi(n)
                  , l = (r = r.concat(Vt(n).filter(function(t) {
                    return !y(r, t)
                }))).map(function(t, e) {
                ...
                o = l.map(function(t, e) {
                    var i = r[e].parentNode === n && (o[e] || Dr(r[e]));
                ...
                ae.all(r.map(function(t, e) {
                    return ["top", "left", "height", "width"].some(function(t) {
                        return o[e][t] !== l[e][t]
                    }) && Je.start(t, l[e], i.animation, "ease")
                }).concat(e !== a && Je.start(n, {
                    height: a
                }, this.animation, "ease"))).then(function() {
                    r.forEach(function(t, e) {
                        return qe(t, {
                            display: 0 === l[e].opacity ? "none" : "",
                            zIndex: ""
                        })
                    }),
                    Ar(n),
    ...
    var $r = {
        ...
        methods: {
            ...
            setState: function(i, n) {
                ...
                Kt(this.$el, "beforeFilter", [this, i]),
                this.toggles.forEach(function(t) {
                    return je(t, r.cls, !!function(t, e, i) {
                        var n = i.filter;
                        void 0 === n && (n = {
                            "": ""
                        });
                        ...
                        B(h) ? c in n && l === n[c] || !l && c && !(c in n) && !n[""] : o === h && s === u
                    }(t, r.attrItem, i))
                }),
                ae.all(Ne(this.target, this.$el).map(function(t) {
                    var e = Vt(t);
                    return n ? r.animate(function() {
                        return Or(i, t, e)
                    }, t) : Or(i, t, e)
                })).then(function() {
    ...
    function Mr(t, e) {
        return Ai(lt(t, e), ["filter"])
    }
    function Or(t, e, i) {
        var n, r, o = (n = t.filter,
        r = "",
        K(n, function(t) {
            return r += t || ""
        }),
        ...
        i.forEach(function(t) {
            return qe(t, "display", o && !$t(t, o) ? "none" : "")
        });
        var s, a, l, c = t.sort, h = c[0], u = c[1];
        h && (a = h,
        l = u,
        V(s = Z([], i).sort(function(t, e) {
            return lt(t, a).localeCompare(lt(e, a), void 0, {
                numeric: !0
            }) * ("asc" === l || -1)
        }), i) || ye(e, s))
    }
    function Hr(t, e, i) {
        ...
        (r || B(s)) && (o ? r ? (delete i.filter[""],
        i.filter[o] = r) : (delete i.filter[o],
        (P(i.filter) || ""in i.filter) && (i.filter = {
            "": r || ""
        })) : i.filter = {
            "": r || ""
        }),
    ...
    var Fr = {
        mixins: [{
            ...
            methods: {
                startAutoplay: function() {
                    ...
                    this.stopAutoplay(),
                    this.interval = setInterval(function() {
                        return (!t.draggable || !Ae(":focus", t.$el)) && (!t.pauseOnHover || !$t(t.$el, ":hover")) && !t.stack.length && t.show("next")
            ...
            events: [{
                ...
                handler: function(t) {
                    var e;
                    !this.draggable || !re(t) && !(e = t.target).children.length && e.childNodes.length || Ot(t.target, Rt) || 0 < t.button || this.length < 2 || this.start(t)
                }
            }, {
                name: "touchmove",
                passive: !1,
            ...
            methods: {
                start: function() {
                    ...
                    Ut(window.visualViewport, "resize", this.unbindMove),
                    Ut(document, vt + " " + _t, this.end, !0),
                ...
                move: function(t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            ...
                            this.percent = o / a;
                            var l, c = n[r], h = n[s], u = this.index !== s, d = r === s;
                    ...
                    Zt(window.visualViewport, "resize", this.unbindMove),
                    this.unbindMove && this.unbindMove(),
                    Zt(document, vt, this.end, !0),
                    this.dragging && (this.dragging = null,
                    this.index === this.prevIndex ? (this.percent = 1 - this.percent,
                    this.dir *= -1,
                    this._show(!1, this.index, !0),
                    this._transitioner = null) : (t = (ut ? this.dir * (ut ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos,
            ...
            update: {
                write: function() {
                    ...
                    je(Ne(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                    this.updateNav()
                },
                events: ["resize"]
            },
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        var e = lt(t, i.attrItem);
                        je(t, i.clsActive, z(e) === n),
                        je(t, "uk-invisible", i.finite && ("previous" === e && 0 === n || "next" === e && n >= i.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
            show: function(t, e) {
                ...
                !this.dragging && this.length) {
                    ...
                    !e && 1 < n.length)
                        ...
                        var s, a = this.getIndex(this.index), l = Be(this.slides, this.clsActive) && this.slides[a], c = this.getIndex(t, this.index), h = this.slides[c];
                        if (l !== h) {
                            if (this.dir = "next" !== (s = t) && ("previous" === s || s < a) ? -1 : 1,
                            this.prevIndex = a,
                            this.index = c,
                            l && !Kt(l, "beforeitemhide", [this]) || !Kt(h, "beforeitemshow", [this, l]))
                                return this.index = this.prevIndex,
                                void o();
                            var u = this._show(l, h, e).then(function() {
                                return l && Kt(l, "itemhidden", [i]),
                                Kt(h, "itemshown", [i]),
                                new ae(function(t) {
                                    _i.write(function() {
                                        n.shift(),
            ...
            _getTransitioner: function(t, e, i, n) {
                ...
                new this.Transitioner(O(t) ? this.slides[t] : t,O(e) ? this.slides[e] : e,i * (ut ? -1 : 1),n)
            }
        }
    };
    function qr(t) {
            ...
            Transitioner: function(o, s, a, t) {
                ...
                return {
                    ...
                    show: function(t, e, i) {
                        ...
                        ae.all([Je.start(s, c[1], t, r), Je.start(o, c[0], t, r)]).then(function() {
                            n.reset(),
                            h.resolve()
                        }, et),
                        h.promise
                    ...
                    translate: function(t) {
                        ...
                        qe(s, e[1]),
                        qe(o, e[0]),
                        Rr(s, "itemtranslatein", {
                            percent: t,
                            dir: a
                        }),
                        Rr(o, "itemtranslateout", {
                            percent: 1 - t,
                            dir: a
                        })
                    },
        ...
        events: [{
            ...
            handler: function(t, r) {
                var o = this
                  ...
                  , s = r.alt;
                void 0 === s && (s = "");
                var a, l, i, c = r.poster, h = r.attrs;
                void 0 === h && (h = {}),
                ...
                "image" === e || n.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i) ? fe(n, h.srcset, h.size).then(function(t) {
                    var e = t.width
                      , i = t.height;
                    return o.setItem(r, Vr("img", Z({
                        src: n,
                        width: e,
                        height: i,
                        alt: s
                    ...
                    return o.setError(r)
                }) : "video" === e || n.match(/\.(mp4|webm|ogv)($|\?)/i) ? (Ut(i = Vr("video", Z({
                    src: n,
                    poster: c,
                    controls: "",
                    playsinline: "",
                ...
                Ut(i, "error", function() {
                    return o.setError(r)
                })) : "iframe" === e || n.match(/\.(html|php)($|\?)/i) ? this.setItem(r, Vr("iframe", Z({
                    src: n,
                    frameborder: "0",
                    allowfullscreen: "",
                    class: "uk-lightbox-iframe"
                }, h))) : (a = n.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) ? this.setItem(r, Vr("iframe", Z({
                    src: "https://www.youtube" + (a[1] || "") + ".com/embed/" + a[2] + (a[3] ? "?" + a[3] : ""),
                    width: 1920,
                    height: 1080
                }, l, h))) : (a = n.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/)) && de("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(n), {
                    responseType: "json",
                    withCredentials: !1
                }).then(function(t) {
                    var e = t.response
                      , i = e.height
                      , n = e.width;
                    return o.setItem(r, Vr("iframe", Z({
    ...
    var Ur, Zr = {
        install: function(t, e) {
            t.lightboxPanel || t.component("lightboxPanel", Xr),
        ...
        methods: {
            show: function(t) {
                var i, e = this, n = J(this.toggles.map(Qr), "source");
                return A(t) && (i = Qr(t).source,
                t = b(n, function(t) {
                    var e = t.source;
                    return i === e
                })),
    ...
    var Kr = {
        ...
        created: function() {
            var t = Ae("." + this.clsContainer + "-" + this.pos, this.$container) || ye(this.$container, '<div class="' + this.clsContainer + " " + this.clsContainer + "-" + this.pos + '" style="display: block"></div>');
        ...
        connected: function() {
            var t, e = this, i = W(qe(this.$el, this.marginProp));
            Je.start(qe(this.$el, this.startProps), ((t = {
                opacity: 1
            })[this.marginProp] = i,
            t)).then(function() {
        ...
        methods: {
            close: function(t) {
                function e() {
                    ...
                    Kt(i.$el, "close", [i]),
                    Ce(i.$el),
                    t && !t.hasChildNodes() && Ce(t)
                }
                var i = this;
                this.timer && clearTimeout(this.timer),
                t ? e() : Je.start(this.$el, this.startProps).then(e)
            }
        }
    }
      , Gr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"]
      , Jr = {
        mixins: [ir],
        ...
        computed: {
            props: function(g, m) {
                ...
                return Gr.reduce(function(t, e) {
                    if (B(g[e]))
                        return t;
                    var i, n, r = e.match(/color/i), o = r || "opacity" === e, s = g[e].slice(0);
                    o && qe(m, e, ""),
                    s.length < 2 && s.unshift(("scale" === e ? 1 : o ? qe(m, e) : 0) || 0);
                    var a, l, c, h, u, d, f = s.reduce(function(t, e) {
                        return M(e) && e.replace(/-|\d/g, "").trim() || t
                    }, "");
                    if (r ? (a = m.style.color,
                    s = s.map(function(t) {
                        return qe(qe(m, "color", t), "color").split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(W)
                    }),
                    m.style.color = a) : w(e, "bg") ? (l = "bgy" === e ? "height" : "width",
                    s = s.map(function(t) {
                        return wi(t, l, v.$el)
                    }),
                    qe(m, "background-position-" + e[2], ""),
                    n = qe(m, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1],
                    i = v.covers ? (c = Math.min.apply(Math, s),
                    h = Math.max.apply(Math, s),
                    u = s.indexOf(c) < s.indexOf(h),
                    d = h - c,
                    s = s.map(function(t) {
                        return t - (u ? c : h)
                    }),
                    (u ? -d : 0) + "px") : n) : s = s.map(W),
                    "stroke" === e) {
            ...
            covers: function(t, e) {
                ...
                r = "cover" === qe(qe(i, "backgroundSize", ""), "backgroundSize"),
        ...
        update: {
            read: function(t) {
                var e, i, n, l, c, h, u = this;
                t.active = this.matchMedia,
                t.active && (t.image || !this.covers || !this.bgProps.length || (e = qe(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) && ((i = new Image).src = e,
                (t.image = i).naturalWidth || (i.onload = function() {
                    return u.$update()
                }
                )),
                (n = t.image) && n.naturalWidth && (l = {
                ...
                this.bgProps.forEach(function(t) {
                    var e, i = u.props[t], n = i.diff, r = i.bgPos, o = i.steps, s = "bgy" === t ? "height" : "width", a = h[s] - l[s];
                    a < n ? l[s] = h[s] + n - a : n < a && (e = l[s] / wi(r, s, u.$el)) && (u.props[t].steps = o.map(function(t) {
                        return t - (a - n) / e
                    })),
                    h = rt.cover(c, l)
                }),
        ...
        methods: {
            ...
            getCss: function(u) {
                ...
                return Object.keys(d).reduce(function(t, e) {
                    ...
                    case "y":
                        n = n || "px",
                        t.transform += " translate" + p(e) + "(" + W(o).toFixed("px" === n ? 0 : 2) + n + ")";
                        break;
                    case "rotate":
                        n = n || "deg",
                        t.transform += " rotate(" + (o + n) + ")";
                        break;
                    case "scale":
                        t.transform += " scale(" + o + ")";
                        break;
                    ...
                    case "hue":
                        n = n || "deg",
                        t.filter += " hue-rotate(" + (o + n) + ")";
                        break;
                    case "fopacity":
                        n = n || "%",
                        t.filter += " opacity(" + (o + n) + ")";
                        break;
                    case "grayscale":
                    case "invert":
                    case "saturate":
        ...
        update: {
            read: function(t, e) {
                ...
                t.active) {
                    var n, r, o = i;
                    return {
                        percent: i = tt((n = Bi(this.target) / (this.viewport || 1)) * (1 - ((r = this.easing) - r * n))),
            ...
            write: function(t) {
                var e = t.style;
                t.active ? e && qe(this.$el, e) : this.reset()
            },
            events: ["scroll", "resize"]
        }
    }
    ...
    function no(t, e, i) {
        var n, r = so(t, e);
        return i ? r - (n = t,
        si(e).width / 2 - si(n).width / 2) : Math.min(r, ro(e))
    }
    function ro(t) {
        return Math.max(0, oo(t) - si(t).width)
    }
    function oo(t) {
        return lo(t).reduce(function(t, e) {
            return si(e).width + t
        }, 0)
    }
    function so(t, e) {
        return (li(t).left + (ut ? si(t).width - si(e).width : 0)) * (ut ? -1 : 1)
    }
    function ao(t, e, i) {
        Kt(t, Gt(e, !1, !1, i))
    }
    ...
    var co = {
        ...
        data: {
            ...
            Transitioner: function(r, n, o, t) {
                var e = t.center
                  ...
                  , c = n ? no(n, a, e) : i + si(r).width * o * (ut ? -1 : 1);
                return {
                    dir: o,
                    show: function(t, e, i) {
                        void 0 === e && (e = 0);
                        ...
                        Je.start(a, {
                            transform: jr(-c * (ut ? -1 : 1), "px")
                        }, t, n).then(l.resolve, et),
                        l.promise
                    },
                    stop: function() {
                        return Je.stop(a)
                    ...
                    translate: function(t) {
                        ...
                        qe(a, "transform", jr(tt(e - e * t - c, -oo(a), si(a).width) * (ut ? -1 : 1), "px")),
                    ...
                    percent: function() {
                        return Math.abs((qe(a, "transform").split(",")[4] * (ut ? -1 : 1) + i) / (c - i))
                    },
                    getDistance: function() {
                        return Math.abs(c - i)
                    },
                    ...
                    getActives: function() {
                        var i = no(r || n, a, e);
                        return G(lo(a).filter(function(t) {
                            var e = so(t, a);
        ...
        computed: {
            ...
            finite: function(t) {
                return t.finite || Math.ceil(oo(this.list)) < si(this.list).width + lo(this.list).reduce(function(t, e) {
            ...
            sets: function(t) {
                ...
                return !P(e = e && this.slides.reduce(function(t, e, i) {
                    var n, r = si(e).width;
                    return a < c + r && (!o.center && i > o.maxIndex && (i = o.maxIndex),
                    y(t, i) || (n = o.slides[i + 1],
                    o.center && n && r < l - si(n).width / 2 ? l -= r : (l = s,
                    t.push(i),
        ...
        connected: function() {
            je(this.$el, this.clsContainer, !Ae("." + this.clsContainer, this.$el))
        },
        update: {
            write: function() {
                var i = this;
                Ne("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                    var e = lt(t, i.attrItem);
                    i.maxIndex && je(t, "uk-hidden", H(e) && (i.sets && !y(i.sets, W(e)) || e > i.maxIndex))
                }),
                !this.length || this.dragging || this.stack.length || (this.reorder(),
                this._translate(1));
                var e = this._getTransitioner(this.index).getActives();
                this.slides.forEach(function(t) {
                    return je(t, i.clsActive, y(e, t))
                }),
                this.sets && !y(this.sets, W(this.index)) || this.slides.forEach(function(t) {
                    return je(t, i.clsActivated, y(e, t))
                })
            },
            events: ["resize"]
        },
        events: {
            beforeitemshow: function(t) {
                ...
                if (!this.dragging && 1 < e) {
                    ...
                    this.duration = qr(this.avgWidth / this.velocity) * (si(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth),
                    this.reorder()
            },
            itemshow: function() {
            ...
            reorder: function() {
                ...
                if (this.finite)
                    ...
                    if (this.slides.forEach(function(t, e) {
                        return qe(t, "order", 0 < i.dir && e < n ? 1 : i.dir < 0 && e >= i.index ? -1 : "")
                    }),
                    this.center)
        ...
        events: [{
            ...
            handler: function(t) {
                var e = t.type
                  ...
                  , s = i.dir;
                Je.cancel(this.$el),
                qe(this.$el, this.getCss(fo(e, s, n))),
                Je.start(this.$el, this.getCss(uo(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(et)
            }
        }, {
            ...
            handler: function(t) {
                var e = t.type
                  ...
                  , r = i.dir;
                Je.cancel(this.$el),
                qe(this.$el, this.getCss(fo(e, r, n)))
            }
        }]
    };
    function uo(t) {
    ...
    var po, go, mo = Z({}, Pr, {
            ...
            write: function() {
                if (this.drag && Ht(this.placeholder)) {
                    ...
                    var f = this.getSortable(d)
                      ...
                      , g = f !== p;
                    if (f && !Yt(d, this.placeholder) && (!g || f.group && f.group === p.group)) {
                        ...
                        y(this.touched, f) || this.touched.push(f)
                    }
                }
            },
            events: ["move"]
        ...
        methods: {
            init: function(t) {
                ...
                !r || n || 0 < i || Ft(e) || Yt(e, "." + this.clsNoDrag) || this.handle && !Yt(e, this.handle) || (t.preventDefault(),
                this.touched = [this],
                this.placeholder = r,
                this.origin = Z({
                    target: e,
                ...
                Ut(document, vt, this.end),
                this.threshold || this.start(t))
            },
            start: function(t) {
                var e, i;
                this.drag = (ot(i = ye(this.$container, (e = this.placeholder).outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2")), "style", ot(i, "style") + ";margin:0!important"),
                qe(i, Z({
                    boxSizing: "border-box",
                    width: e.offsetWidth,
                    height: e.offsetHeight,
                    overflow: "hidden"
                }, qe(e, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
                hi(i.firstElementChild, hi(e.firstElementChild)),
                i);
                var n, r, o = this.placeholder.getBoundingClientRect(), s = o.left, a = o.top;
                Z(this.origin, {
                    offsetLeft: this.pos.x - s,
                    offsetTop: this.pos.y - a
                }),
                Me(this.drag, this.clsDrag, this.clsCustom),
                Me(this.placeholder, this.clsPlaceholder),
                Me(this.items, this.clsItem),
                ...
                po = setInterval(function() {
                    ...
                    var l = .3 * (Date.now() - r);
                    r = Date.now(),
                    ji(document.elementFromPoint(t, n.y)).some(function(t) {
                        var e = t.scrollTop
                          , i = t.scrollHeight
                          , n = si(zi(t))
                          , r = n.top
            ...
            move: function(t) {
                ...
                Oe(document.documentElement, this.clsDragState)) : "touchend" === t.type && t.target.click()
            },
            insert: function(i, n) {
                var r = this;
                function t() {
                    var t, e;
                    n ? (!Yt(i, r.target) || (e = n,
                    (t = i).parentNode === e.parentNode && ge(t) > ge(e)) ? _e : be)(n, i) : ye(r.target, i)
                }
                Me(this.items, this.clsItem),
                this.animation ? this.animate(t) : t()
            },
            remove: function(t) {
                Yt(t, this.target) && (this.animation ? this.animate(function() {
                    return Ce(t)
                }) : Ce(t))
            },
        ...
        methods: {
            show: function() {
                var e = this;
                !this.isActive() && this.title && (yo.forEach(function(t) {
                    return t.hide()
                }),
                yo.push(this),
                this._unbind = Ut(document, vt, function(t) {
            ...
            hide: function() {
                var t = this;
                this.isActive() && !$t(this.$el, "input:focus") && this.toggleElement(this.tooltip, !1, !1).then(function() {
                    yo.splice(yo.indexOf(t), 1),
            ...
            _show: function() {
                ...
                Ut(this.tooltip, "toggled", function() {
        ...
        events: {
            change: function(t) {
                $t(t.target, 'input[type="file"]') && (t.preventDefault(),
            ...
            drop: function(t) {
                ...
                e && e.files && (Oe(this.$el, this.clsDragover),
                this.upload(e.files))
            },
...
function(t, e) {
    ...
    return "undefined" != typeof window && window.UIkit && window.UIkit.use(e),
    e
}),
function(l, c, o, a) {
    function i(t, e) {
    ...
    function t(t) {
        var e, i, n = o.createElement("div"), r = t;
        for (e in r)
            if (i = r[e],
            void 0 !== n.style[i])
                return n = null,
    ...
    i.Pipe = [{
        ...
        filter: ["items", "settings"],
        run: function() {
            var t, e, i = this._clones, n = this._items, r = this.settings.loop ? i.length - Math.max(2 * this.settings.items, 4) : 0;
            for (t = 0,
            e = Math.abs(r / 2); t < e; t++)
                0 < r ? (this.$stage.children().eq(n.length + i.length - 1).remove(),
                i.pop(),
        ...
        run: function() {
            ...
            i = this._clones.length + this._items.length; e < i; e++)
                ...
                o += (this.settings.autoWidth ? this._items[this.relative(e)].width() + this.settings.margin : r * t) * n,
                this._coordinates.push(o)
        }
    }, {
        filter: ["width", "items", "settings"],
        run: function() {
            var t, e, i = (this.width() / this.settings.items).toFixed(3), n = {
            ...
            !this.settings.autoWidth && 0 < l.grep(this._mergers, function(t) {
                ...
                e = this._coordinates.length; t < e; t++)
                    n.width = Math.abs(this._coordinates[t]) - Math.abs(this._coordinates[t - 1] || 0) - this.settings.margin,
    ...
    i.prototype.initialize = function() {
        ...
        this.browserSupport(),
        this.settings.autoWidth && !0 !== this.state.imagesLoaded) && (t = this.$element.find("img"),
    ...
    i.prototype.setup = function() {
        ...
        }).addClass("owl-responsive-" + i)) : n = l.extend({}, this.options),
    ...
    i.prototype.onThrottledResize = function() {
        ...
        this.resizeTimer = c.setTimeout(this.e._onResize, this.settings.responsiveRefreshRate)
    }
    ,
    ...
    i.prototype.internalEvents = function() {
        var t = ("ontouchstart"in c || navigator.msMaxTouchPoints,
    ...
    i.prototype.onDragStart = function(t) {
        var e, i, n, r;
        if (3 === (e = t.originalEvent || t || c.event).which || this.state.isTouch)
            return !1;
    ...
    i.prototype.onDragMove = function(t) {
        var e, i, n, r, o, s;
        this.state.isTouch && (this.state.isScrolling || (i = h(e = t.originalEvent || t || c.event).x,
        n = h(e).y,
        ...
        this.drag.currentX = Math.max(Math.min(this.drag.currentX, r + s), o + s)),
    ...
    i.prototype.closest = function(i) {
        ...
        return this.settings.freeDrag || l.each(o, l.proxy(function(t, e) {
            return e - 30 < i && i < e + 30 ? n = t : this.op(i, "<", e) && this.op(i, ">", o[t + 1] || e - r) && (n = "left" === this.state.direction ? t + 1 : t),
            -1 === n
        }, this)),
    ...
    i.prototype.maximum = function(t) {
        ...
        if (!o.loop && o.center)
            ...
            if (o.loop || o.center)
                ...
                i = this.$stage.width() - this.$element.width(); (n = this.coordinates(r)) && !(n * revert >= i); )
                    e = ++r
            }
        else
            e = this._items.length - o.items;
    ...
    i.prototype.to = function(t, e) {
        if (this.settings.loop) {
            ...
            o < this.settings.items && !1 == s ? (n = r + this._items.length,
            this.reset(n)) : o >= a - this.settings.items && !0 == s && (n = r - this._items.length,
            this.reset(n)),
            c.clearTimeout(this.e._goToLoop),
            this.e._goToLoop = c.setTimeout(l.proxy(function() {
    ...
    i.prototype.preloadAutoWidthImages = function(i) {
        ...
        i.each(function(t, e) {
            ...
            (s = new Image).onload = function() {
                ...
                o.attr("src", s.src),
                o.css("opacity", 1),
                n >= i.length && (r.state.imagesLoaded = !0,
                r.initialize())
            }
            ,
    ...
    i.prototype.trigger = function(t, e, i) {
        ...
        this.settings && "function" == typeof this.settings[r] && this.settings[r].apply(this, o)),
        o
    }
    ,
        ...
        this._handlers = {
            "initialized.owl.carousel change.owl.carousel": a.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var e = this._core.settings, i = e.center && Math.ceil(e.items / 2) || e.items, n = e.center && -1 * i || 0, r = (t.property && t.property.value || this._core.current()) + n, o = this._core.clones().length, s = a.proxy(function(t, e) {
                        this.load(e)
                    }, this); n++ < i; )
...
function(h, e, i) {
    ...
    n.prototype.fetch = function(t, e) {
        ...
        if (-1 < (n = s.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
        else {
    ...
    n.prototype.thumbnail = function(e, t) {
        ...
        var n, r, o = t.width && t.height ? 'style="width:' + t.width + "px;height:" + t.height + 'px;"' : "", s = e.find("img"), a = "src", l = "", c = this._core.settings;
        return e.wrap('<div class="owl-video-wrapper"' + o + "></div>"),
        this._core.settings.lazyLoad && (a = "data-src",
        l = "owl-lazy"),
        s.length ? (i(s.attr(a)),
        s.remove(),
        !1) : void ("youtube" === t.type ? (r = "http://img.youtube.com/vi/" + t.id + "/hqdefault.jpg",
        i(r)) : "vimeo" === t.type && h.ajax({
            type: "GET",
    ...
    n.prototype.play = function(t) {
        ...
        this._playing && this.stop();
        var e, i, n = h(t.target || t.srcElement), r = n.closest("." + this._core.settings.itemClass), o = this._videos[r.attr("data-video")], s = o.width || "100%", a = o.height || this._core.$stage.height();
        "youtube" === o.type ? e = '<iframe width="' + s + '" height="' + a + '" src="http://www.youtube.com/embed/' + o.id + "?autoplay=1&v=" + o.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === o.type && (e = '<iframe src="http://player.vimeo.com/video/' + o.id + '?autoplay=1" width="' + s + '" height="' + a + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
        r.addClass("owl-video-playing"),
        this._playing = r,
        i = h('<div style="height:' + a + "px; width:" + s + 'px" class="owl-video-frame">' + e + "</div>"),
        n.after(i)
    }
    ,
    n.prototype.isInFullScreen = function() {
        var t = i.fullscreenElement || i.mozFullScreenElement || i.webkitFullscreenElement;
        return t && h(t).parent().hasClass("owl-video-frame") && (this._core.speed(0),
        this._fullscreen = !0),
...
function(s) {
    ...
    e.prototype.swap = function() {
        if (1 === this.core.settings.items && this.core.support3d) {
            ...
            r && n.addClass("animated owl-animated-in").addClass(r).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", e))
        }
    }
    ,
...
function(o) {
    ...
    e.prototype.initialize = function() {
        ...
        this._controls.$indicators.on("click", "div", o.proxy(function(t) {
        ...
        this._controls.$previous.addClass(i.navClass[0]).html(i.navText[0]).hide().prependTo(t).on("click", o.proxy(function() {
            this.prev(i.navSpeed)
        }, this)),
        this._controls.$next.addClass(i.navClass[1]).html(i.navText[1]).hide().appendTo(t).on("click", o.proxy(function() {
    ...
    e.prototype.update = function() {
        var t, e, i = this._core.settings, n = this._core.clones().length / 2, r = n + this._core.items().length, o = i.center || i.autoWidth || i.dotData ? 1 : i.dotsEach || i.items;
    ...
    e.prototype.draw = function() {
        var t, e, i = "", n = this._core.settings, r = (this._core.$stage.children(),
        this._core.relative(this._core.current()));
        if (!n.nav || n.loop || n.navRewind || (this._controls.$previous.toggleClass("disabled", r <= 0),
        ...
        n.dots) {
            if (t = this._pages.length - this._controls.$indicators.children().length,
            n.dotData && 0 != t) {
                for (e = 0; e < this._controls.$indicators.children().length; e++)
                    i += this._templates[this._core.relative(e)];
                this._controls.$indicators.html(i)
            } else
                0 < t ? (i = new Array(1 + t).join(this._templates[0]),
                this._controls.$indicators.append(i)) : t < 0 && this._controls.$indicators.children().slice(t).remove();
            this._controls.$indicators.find(".active").removeClass("active"),
            this._controls.$indicators.children().eq(o.inArray(this.current(), this._pages)).addClass("active")
        }
    ...
    e.prototype.to = function(t, e, i) {
        var n;
        i ? o.proxy(this._overrides.to, this._core)(t, e) : (n = this._pages.length,
        o.proxy(this._overrides.to, this._core)(this._pages[(t % n + n) % n].start, e))
    }
    ,
...
function(i, n) {
    ...
    var e = function(t) {
        ...
        this.$element.on(this._handlers),
        i(n).on("hashchange.owl.navigation", i.proxy(function() {
    ...
    e.prototype.destroy = function() {
        var t, e;
        for (t in i(n).off("hashchange.owl.navigation"),
        this._handlers)
            this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this))
            "function" != typeof this[e] && (this[e] = null)
...
function() {
    ...
    D.fn.stick_in_parent = function(t) {
        ...
        ,
        e = function(r, o, s, a, l, c, h, u) {
            var d, t, f, p, g, m, v, w, e, y, _, n;
            if (!r.data("sticky_kit")) {
                if (r.data("sticky_kit", !0),
                g = b.height(),
                v = r.parent(),
                null != S && (v = v.closest(S)),
                !v.length)
                    throw "failed to find stick parent";
                if (d = f = !1,
                (_ = null != k ? k && r.closest(k) : D("<div />")) && _.css("position", r.css("position")),
                (w = function() {
                    var t, e, i;
                    if (!u && (g = b.height(),
                    ...
                    i = !0),
                    l = r.offset().top - (parseInt(r.css("margin-top"), 10) || 0) - E,
                    c = r.outerHeight(!0),
                    h = r.css("float"),
                    _ && _.css({
                        width: T(r),
                ...
                c !== a)
                    ...
                    n = function() {
                        ...
                        i < l && (f = !1,
                        m = E,
                        null == k && ("left" !== h && "right" !== h || r.insertAfter(_),
                        _.detach()),
                        t = {
                            position: "",
                            width: "",
                        ...
                        r.css(t).addClass(I),
                        null == k && (r.after(_),
                        "left" !== h && "right" !== h || _.append(r)),
                        r.trigger("sticky_kit:stick")),
                        f && x && (null == n && (n = a + s < i + c + m),
                        !d && n)))
                            return d = !0,
                    ...
                    t = function() {
                        ...
                        v.position("position", ""),
                        f)
                            return null == k && ("left" !== h && "right" !== h || r.insertAfter(_),
                            _.remove()),
                            r.removeClass(I)
                    }
                    ,
...
.call(this),
function(r) {
    var t, e, o = "jquery-stickit", n = o + "-spacer", i = ":" + o, s = -1 != navigator.userAgent.indexOf("MSIE 7.0"), a = s ? -2 : 0, l = void 0 !== window.MutationObserver, c = window.StickScope = {
        Parent: 0,
        Document: 1
    }, h = 0, u = 1, d = 2, f = !1, p = !1;
    function g(t, e) {
        ...
        "auto" == this.defaultZIndex ? this.defaultZIndex = 100 : "0" == this.defaultZIndex && "none" != i && (this.defaultZIndex = 100),
        this.updateOptions(),
        this.offsetY = 0,
        this.lastY = 0,
        this.stick = h,
        this.spacer = r("<div />"),
        this.spacer[0].id = t.id,
        this.spacer[0].className = t.className,
        this.spacer[0].style.cssText = t.style.cssText,
        this.spacer.addClass(n),
        ...
        "none" == i ? this.element.css("transform", "translateZ(0)") : -1 == i.indexOf("matrix3d") && this.element.css("transform", this.element.css("transform") + " translateZ(0)"),
        this.bound(),
        this.precalculate(),
        this.store()
    }
    ...
    function y() {
        ...
        r(i).each(function() {
            r(this).data(o).enableWillChange(!t)
        })
    }
    function _(t) {
        p || v()
    ...
    ,
    g.prototype.isActive = function(t) {
        return (void 0 === t.screenMinWidth || e >= t.screenMinWidth) && (void 0 === t.screenMaxWidth || e <= t.screenMaxWidth)
    }
    ,
    g.prototype.updateCss = function(t) {
        ...
        var e = {};
        this.stick == d ? this.options.extraHeight != t.extraHeight && (e.bottom = -this.options.extraHeight + "px") : this.options.top != t.top && (e.top = t.top + this.offsetY + "px"),
    ...
    g.prototype.updateOptions = function() {
        ...
        if (this.activeKey != t) {
            ...
            this.options && (t ? this.stick != h && (e.scope == this.options.scope ? this.updateCss(e) : (this.reset(),
            setTimeout(this.locate.bind(this)))) : this.reset()),
            this.options = e,
            this.zIndex = this.getZIndex(e)
        }
    }
    ,
    g.prototype.getZIndex = function(t) {
    ...
    g.prototype.getActiveOptions = function() {
        for (var t = {}, e = 0; e < this.optionList.length; ++e) {
            var i = this.optionList[e];
            this.isActive(i) && r.extend(t, i)
        }
        return t.scope = t.scope || c.Parent,
        t.className = t.className || "stick",
        t.top = t.top || 0,
        t.extraHeight = t.extraHeight || 0,
        void 0 === t.overflowScrolling && (t.overflowScrolling = !0),
        t
    }
    ,
    ...
    g.prototype.bound = function() {
        var t = this.element;
        if (s || "border-box" != t.css("box-sizing"))
            this.extraWidth = 0;
        else {
            var e = parseFloat(t.css("border-left-width")) || 0
              , i = parseFloat(t.css("border-right-width")) || 0
              , n = parseFloat(t.css("padding-left")) || 0
              , r = parseFloat(t.css("padding-right")) || 0;
            this.extraWidth = e + i + n + r
        }
        this.margin = {
    ...
    g.prototype.precalculate = function() {
        ...
        this.offsetHeight = this.options.overflowScrolling ? Math.max(this.element.outerHeight(!1) + this.basePadding - t, 0) : 0,
        this.minOffsetHeight = -this.offsetHeight
    }
    ,
    g.prototype.reset = function() {
        this.stick == d ? (this.trigger("unend"),
        this.trigger("unstick")) : this.stick == u && this.trigger("unstick"),
        this.stick = h,
    ...
    ,
    g.prototype.setAbsolute = function(t) {
        this.stick == h && (this.element.addClass(this.options.className),
        this.trigger("stick")),
        this.trigger("end"),
        this.stick = d,
        this.element.css({
    ...
    ,
    g.prototype.setFixed = function(t, e, i) {
        this.stick == h ? (this.element.addClass(this.options.className),
    ...
    g.prototype.locate = function() {
        if (this.activeKey) {
            var t, e, i, n = this.element, r = this.spacer;
            switch (this.stick) {
            case u:
                0 <= (e = (t = r[0].getBoundingClientRect()).top - this.baseTop) || this.isHeigher() ? this.reset() : this.options.scope == c.Parent && (t = n.parent()[0].getBoundingClientRect()).bottom + this.baseParentOffset + this.offsetHeight <= n.outerHeight(!1) + this.basePadding ? this.setAbsolute(this.spacer.position().left) : this.updateScroll(t.bottom);
                break;
            case d:
                e = (t = r[0].getBoundingClientRect()).top - this.baseTop,
                i = t.left - this.margin.left,
                0 <= e || this.isHeigher() ? this.reset() : (t = n.parent()[0].getBoundingClientRect()).bottom + this.baseParentOffset + this.offsetHeight > n.outerHeight(!1) + this.basePadding && this.setFixed(i + a, t.bottom, -this.offsetHeight);
                break;
            case h:
            default:
                if (0 <= (e = (t = n[0].getBoundingClientRect()).top - this.baseTop) || this.isHeigher())
                    return;
                var o = n.parent()[0].getBoundingClientRect();
                r.height(n.height()),
                r.show(),
                i = t.left - this.margin.left,
                this.options.scope == c.Document ? this.setFixed(i, t.bottom, 0) : o.bottom + this.baseParentOffset + this.offsetHeight <= n.outerHeight(!1) + this.basePadding ? this.setAbsolute(this.element.position().left) : this.setFixed(i + a, t.bottom, 0),
                r.width() || r.width(n.width())
            }
        }
    }
    ,
    g.prototype.refresh = function() {
        ...
        this.stick != h) {
            var t = this.element
              , e = this.spacer;
            if (this.lastValues.width != e.width() && t.width(this.lastValues.width = e.width()),
            this.lastValues.height != t.height() && e.height(this.lastValues.height = t.height()),
            this.stick == u) {
    ...
    ,
    g.prototype.enableWillChange = function(t) {
        "auto" == this.origWillChange && this.element.css("will-change", t ? "transform" : this.origWillChange)
    }
    ;
    var b = ["destroy", "refresh"];
    r.fn.stickit = function(e, i) {
        if ("string" == typeof e) {
            if (-1 != r.inArray(e, b)) {
                var n = arguments;
                this.each(function() {
                    var t = r(this).data(o);
                    t && t[e].apply(t, Array.prototype.slice.call(n, 1))
                })
            }
        } else {
            if (!f)
                ...
                r(document).ready(function() {
                    r(window).bind("resize", m).bind("scroll", w),
                    r(document.body).bind("animationend webkitAnimationEnd oAnimationEnd transitionend webkitTransitionEnd oTransitionEnd", w),
                    r(document).bind("webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange", y)
                }),
                l)
                    new MutationObserver(_).observe(document, {
                        attributes: !0,
                        childList: !0,
                        characterData: !0,
                        subtree: !0
                    });
            i = r.isArray(e) ? e : Array.prototype.slice.call(arguments, 0),
            this.each(function() {
                var t = new g(this,i);
                r(this).data(o, t),
                t.locate()
...
function() {
    ...
    function i(t, e) {
        ...
        i.browser_is_supported() && (this.is_multiple = this.form_field.multiple,
    ...
    ,
    (s = e).select_to_array = function(t) {
        var e, i, n, r, o;
        for (i = new s,
        n = 0,
        r = (o = t.childNodes).length; n < r; n++)
    ...
    i.prototype.results_option_build = function(t) {
        ...
        for (e = "",
        o = r = 0,
        s = (a = this.results_data).length; o < s && ((n = "") !== (n = (i = a[o]).group ? this.result_add_group(i) : this.result_add_option(i)) && (r++,
        e += n),
    ...
    i.prototype.reset_single_select_options = function() {
        ...
        for (r = [],
        e = 0,
        i = (n = this.results_data).length; e < i; e++)
            (t = n[e]).selected ? r.push(t.selected = !1) : r.push(void 0);
        return r
    }
    ,
    ...
    i.prototype.winnow_results = function() {
        ...
        c = 0,
        h = (u = this.results_data).length; c < h; c++)
            (e = u[c]).search_match = !1,
            r = null,
            this.include_option_in_results(e) && (e.group && (e.group_match = !1,
            e.active_options = 0),
            null != e.group_array_index && this.results_data[e.group_array_index] && (0 === (r = this.results_data[e.group_array_index]).active_options && r.search_match && (n += 1),
            r.active_options += 1),
            ...
            e.search_match ? (o.length && (s = e.search_text.search(l),
            a = e.search_text.substr(0, s + o.length) + "</em>" + e.search_text.substr(s + o.length),
            e.search_text = a.substr(0, s) + "<em>" + a.substr(s)),
            null != r && (r.group_match = !0)) : null != e.group_array_index && this.results_data[e.group_array_index].search_match && (e.search_match = !0)));
        return this.result_clear_highlight(),
        n < 1 && o.length ? (this.update_results_content(""),
    ...
    i.prototype.search_string_match = function(t, e) {
        ...
        if (e.test(t))
            return !0;
        if (this.enable_split_word_search && (0 <= t.indexOf(" ") || 0 === t.indexOf("[")) && (n = t.replace(/\[|\]/g, "").split(" ")).length)
            for (r = 0,
            o = n.length; r < o; r++)
                if (i = n[r],
                e.test(i))
    ...
    i.prototype.choices_count = function() {
        ...
        for (t = this.selected_option_count = 0,
    ...
    (l = jQuery).fn.extend({
        chosen: function(n) {
            return t.browser_is_supported() ? this.each(function(t) {
                var e, i;
                i = (e = l(this)).data("chosen"),
                "destroy" !== n ? i instanceof r || e.data("chosen", new r(this,n)) : i instanceof r && i.destroy()
            }) : this
        }
    }),
    function(t, e) {
    ...
    n.prototype.setup = function() {
        return this.form_field_jq = l(this.form_field),
    ...
    ,
    n.prototype.destroy = function() {
        return l(this.container[0].ownerDocument).unbind("click.chosen", this.click_test_action),
    ...
    n.prototype.container_mousedown = function(t) {
        ...
        null == t || !l(t.target).hasClass("search-choice-close")))
            return this.active_field ? this.is_multiple || !t || l(t.target)[0] !== this.selected_item[0] && !l(t.target).parents("a.chosen-single").length || (t.preventDefault(),
    ...
    n.prototype.result_do_highlight = function(t) {
        ...
        if (t.length) {
            ...
            (n = parseInt(this.search_results.css("maxHeight"), 10)) + (r = this.search_results.scrollTop()) <= (e = (i = this.result_highlight.position().top + this.search_results.scrollTop()) + this.result_highlight.outerHeight()))
    ...
    n.prototype.search_results_mouseup = function(t) {
        var e;
        if ((e = l(t.target).hasClass("active-result") ? l(t.target) : l(t.target).parents(".active-result").first()).length)
            return this.result_highlight = e,
    ...
    n.prototype.search_results_mouseover = function(t) {
        var e;
        if (e = l(t.target).hasClass("active-result") ? l(t.target) : l(t.target).parents(".active-result").first())
            return this.result_do_highlight(e)
    }
    ,
    n.prototype.search_results_mouseout = function(t) {
        if (l(t.target).hasClass("active-result"))
            return this.result_clear_highlight()
    }
    ,
    n.prototype.choice_build = function(t) {
        ...
        t.disabled ? e.addClass("search-choice-disabled") : ((i = l("<a />", {
    ...
    n.prototype.choice_destroy_link_click = function(t) {
        ...
        t.stopPropagation(),
        !this.is_disabled)
            return this.choice_destroy(l(t.target))
    }
    ,
    ...
    n.prototype.no_results = function(t) {
        var e;
        return (e = l('<li class="no-results">' + this.results_none_found + ' "<span></span>"</li>')).find("span").first().html(t),
    ...
    n.prototype.search_field_scale = function() {
        var t, e, i, n, r, o, s, a;
        if (this.is_multiple) {
            for (n = "position:absolute; left: -1000px; top: -1000px; display:none;",
            s = o = 0,
            a = (r = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"]).length; s < a; s++)
                n += (i = r[s]) + ":" + this.search_field.css(i) + ";";
            return (t = l("<div />", {
                style: n
...
function(g) {
    ...
    var m;
    if (void 0 === m) {
        var t = g('<div style="background:none;display:none;"/>').appendTo("body");
        m = t.css("backgroundColor"),
        t.remove()
    }
    g.fn.rippleEffect = function(t) {
        var p = g.extend({}, g.fn.rippleEffect.defaults, t);
        return this.each(function() {
            g(this).on("click", function(t) {
                var e, i, n, r, o, s, a, l, c = g(this), h = t.type;
                function u() {
                    return "" != p.inkColor ? p.inkColor : function(t, e) {
                        var i, n, r, o;
                        i = function(t, i) {
                            return function t(e) {
                                return e.css("backgroundColor") == m ? e.is("body") ? i || m : t(e.parent()) : e.css("backgroundColor")
                            }(t)
                        }(t, e),
                        n = g.fn.rippleEffect.colorToHex(i),
                        o = (r = g.fn.rippleEffect.getLuminationValue(n)) <= 239 ? r <= 70 ? g.fn.rippleEffect.getColorLuminance(n, .8) : g.fn.rippleEffect.getColorLuminance(n, .2) : g.fn.rippleEffect.getColorLuminance(n, -.15);
                        return o
                    }(l, p.inkDefaultColor)
                }
                if (l = c,
                ...
                !a.height() && !a.width()) {
                    if (o = Math.max(l.outerWidth(), l.outerHeight()),
                    void 0 !== c.data("ripple") && "" != c.data("ripple"))
                        s = c.data("ripple");
                    else if (void 0 !== c.data("ripple-getcolorfromid") && "" != c.data("ripple-getcolorfromid")) {
                        var d = c.data("ripple-getcolorfromid");
                        s = 0 < g(d).length ? g(d).css("background-color") : u()
                    } else
                        s = u();
                    a.css({
                        height: o,
                ...
                if ("click" === h)
                    e = t.pageX,
                    i = t.pageY;
                else if ("touchstart" === h) {
                    var f = t.originalEvent.touches[0] || t.originalEvent.changedTouches[0];
                    e = f.pageX,
                    i = f.pageY
                }
                n = e - l.offset().left - a.width() / 2,
                r = i - l.offset().top - a.height() / 2,
                a.css({
                    top: r + "px",
                    left: n + "px"
                }).addClass("animate"),
    ...
    g.fn.rippleEffect.getLuminationValue = function(t) {
        t = t.substring(1);
        var e = parseInt(t, 16);
        return .2126 * (e >> 16 & 255) + .7152 * (e >> 8 & 255) + .0722 * (e >> 0 & 255)
    }
    ,
    g.fn.rippleEffect.getColorLuminance = function(t, e) {
        (t = String(t).replace(/[^0-9a-f]/gi, "")).length < 6 && (t = t[0] + t[0] + t[1] + t[1] + t[2] + t[2]),
        e = e || 0;
        var i, n, r = "#";
        for (n = 0; n < 3; n++)
            i = parseInt(t.substr(2 * n, 2), 16),
            r += ("00" + (i = Math.round(Math.min(Math.max(0, i + i * e), 255)).toString(16))).substr(i.length);
        return r
    }
    ,
    g.fn.rippleEffect.colorToHex = function(t) {
...
function o(s, a, l) {
            ...
            t.fn.perfectScrollbar = function(i) {
                return this.each(function() {
                    if ("object" == typeof i || void 0 === i) {
                        ...
                        var e = i;
                        "update" === e ? r.update(this) : "destroy" === e && r.destroy(this)
                    }
                })
            }
        }
        ...
        e.exports = function(t) {
            !function(i, n) {
                ...
                n.event.bind(n.scrollbarYRail, "click", function(t) {
                    var e = t.pageY - window.pageYOffset - r(n.scrollbarYRail).top > n.scrollbarYTop ? 1 : -1;
                ...
                n.event.bind(n.scrollbarXRail, "click", function(t) {
                    var e = t.pageX - window.pageXOffset - r(n.scrollbarXRail).left > n.scrollbarXLeft ? 1 : -1;
        ...
        function n(r, o) {
            function e(t) {
                (function(t) {
                    ...
                    var n = a.toInt(o.scrollbarXLeft * (o.contentWidth - o.containerWidth) / (o.containerWidth - o.railXRatio * o.scrollbarXWidth)) - o.negativeScrollAdjustment;
                    h(r, "left", n)
                }
                )(t.pageX - n),
                c(r),
        ...
        function r(r, o) {
            function e(t) {
                (function(t) {
                    ...
                    var n = a.toInt(o.scrollbarYTop * (o.contentHeight - o.containerHeight) / (o.containerHeight - o.railYRatio * o.scrollbarYHeight));
                    h(r, "top", n)
                }
                )(t.pageY - n),
                c(r),
                ...
                if (!(t.isDefaultPrevented && t.isDefaultPrevented() || t.defaultPrevented)) {
                    ...
                    if (a || e) {
                        ...
                        case 37:
                            ...
                            break;
                        case 38:
                            r = t.metaKey ? s.contentHeight : t.altKey ? s.containerHeight : 30;
                            break;
                        case 39:
                            n = t.metaKey ? s.contentWidth : t.altKey ? s.containerWidth : 30;
                            break;
        ...
        function n(o, r) {
            function t(t) {
                var e = function(t) {
                  ...
                  , n = e[1];
                !function(t, e) {
                    var i = o.querySelector("textarea:hover, select[multiple]:hover, .ps-child:hover");
                    if (i) {
                ...
                r.settings.useBothWheelAxes ? r.scrollbarYActive && !r.scrollbarXActive ? (l(o, "top", n ? o.scrollTop - n * r.settings.wheelSpeed : o.scrollTop + i * r.settings.wheelSpeed),
                s = !0) : r.scrollbarXActive && !r.scrollbarYActive && (l(o, "left", i ? o.scrollLeft + i * r.settings.wheelSpeed : o.scrollLeft - n * r.settings.wheelSpeed),
                s = !0) : (l(o, "top", o.scrollTop - n * r.settings.wheelSpeed),
                l(o, "left", o.scrollLeft + i * r.settings.wheelSpeed)),
                a(o),
                (s = s || function(t, e) {
                    var i = o.scrollTop;
                    if (0 === t) {
        ...
        function n(a, t) {
            ...
            t.event.bind(window, "mousemove", function(t) {
                if (u) {
                    ...
                    e < n + 3 ? (h.left = -5,
                    d.startScrolling(a, "x")) : r - 3 < e ? (h.left = 5,
                    d.startScrolling(a, "x")) : h.left = 0,
                    i < o + 3 ? (h.top = o + 3 - i < 5 ? -5 : -20,
                    d.startScrolling(a, "y")) : s - 3 < i ? (h.top = i - s + 3 < 5 ? 5 : 20,
                    d.startScrolling(a, "y")) : h.top = 0,
                    0 === h.top && 0 === h.left ? l() : c = c || setInterval(function() {
                        return f.get(a) ? (g(a, "top", a.scrollTop + h.top),
                        g(a, "left", a.scrollLeft + h.left),
    ...
    16: [function(t, e, i) {
        ...
        function n(a, l, t, e) {
            function c(t, e) {
                _(a, "top", a.scrollTop - e),
                _(a, "left", a.scrollLeft - t),
                y(a)
            }
            function i() {
                m = !0
            ...
            function r(t) {
                if (!v && l.settings.swipePropagation && d(t),
                !m && v && u(t)) {
                    var e = h(t)
                      , i = {
                        pageX: e.pageX,
                    ...
                    function(t, e) {
                        ...
                        } else if (o < r && (t < 0 && n === l.contentWidth - l.containerWidth || 0 < t && 0 === n))
                            return !l.settings.swipePropagation;
                        return !0
                    }(n, r) && (t.stopPropagation(),
                    t.preventDefault())
                }
            }
            function o() {
                ...
                s = setInterval(function() {
                    return w.get(a) && (g.x || g.y) ? Math.abs(g.x) < .01 && Math.abs(g.y) < .01 ? void clearInterval(s) : (c(30 * g.x, 30 * g.y),
                    g.x *= .8,
            ...
            var f = {}
              ...
              , m = !1
              , v = !1;
            t && (l.event.bind(window, "touchstart", i),
            l.event.bind(window, "touchend", n),
            l.event.bind(a, "touchstart", d),
            l.event.bind(a, "touchmove", r),
            l.event.bind(a, "touchend", o)),
            e && (window.PointerEvent ? (l.event.bind(window, "pointerdown", i),
            l.event.bind(window, "pointerup", n),
            l.event.bind(a, "pointerdown", d),
            l.event.bind(a, "pointermove", r),
            l.event.bind(a, "pointerup", o)) : window.MSPointerEvent && (l.event.bind(window, "MSPointerDown", i),
            l.event.bind(window, "MSPointerUp", n),
        ...
        var r = t("../../lib/helper")
          ...
          , _ = t("../update-scroll");
        e.exports = function(t) {
            (r.env.supportsTouch || r.env.supportsIePointer) && n(t, w.get(t), r.env.supportsTouch, r.env.supportsIePointer)
        }
    }
    , {
        "../../lib/helper": 6,
    ...
    18: [function(t, e, i) {
        ...
        function n(t) {
            ...
            o.isNegativeScroll = (r = t.scrollLeft,
            t.scrollLeft = -1,
            n = t.scrollLeft < 0,
            t.scrollLeft = r,
            n),
            ...
            o.scrollbarXRail = c.appendTo(c.e("div", "ps-scrollbar-x-rail"), t),
            o.scrollbarX = c.appendTo(c.e("div", "ps-scrollbar-x"), o.scrollbarXRail),
            ...
            o.railXWidth = null,
            o.railXRatio = null,
            o.scrollbarYRail = c.appendTo(c.e("div", "ps-scrollbar-y-rail"), t),
            o.scrollbarY = c.appendTo(c.e("div", "ps-scrollbar-y"), o.scrollbarYRail),
    ...
    19: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            t.contains(i.scrollbarXRail) || (0 < (e = s.queryChildren(t, ".ps-scrollbar-x-rail")).length && e.forEach(function(t) {
                s.remove(t)
            }),
            s.appendTo(i.scrollbarXRail, t)),
            t.contains(i.scrollbarYRail) || (0 < (e = s.queryChildren(t, ".ps-scrollbar-y-rail")).length && e.forEach(function(t) {
                s.remove(t)
            }),
            ...
            i.scrollbarXWidth = n(i, r.toInt(i.railXWidth * i.containerWidth / i.contentWidth)),
            i.scrollbarXLeft = r.toInt((i.negativeScrollAdjustment + t.scrollLeft) * (i.railXWidth - i.scrollbarXWidth) / (i.contentWidth - i.containerWidth))) : i.scrollbarXActive = !1,
            ...
            i.scrollbarYHeight = n(i, r.toInt(i.railYHeight * i.containerHeight / i.contentHeight)),
            i.scrollbarYTop = r.toInt(t.scrollTop * (i.railYHeight - i.scrollbarYHeight) / (i.contentHeight - i.containerHeight))) : i.scrollbarYActive = !1,
            ...
            i.scrollbarXActive ? o.add(t, "ps-active-x") : (o.remove(t, "ps-active-x"),
            i.scrollbarXWidth = 0,
            i.scrollbarXLeft = 0,
            l(t, "left", 0)),
            i.scrollbarYActive ? o.add(t, "ps-active-y") : (o.remove(t, "ps-active-y"),
    ...
    20: [function(t, e, i) {
        ...
        e.exports = function(t, e, i) {
            ...
            t.dispatchEvent(r("ps-y-reach-start"))),
            "left" === e && i <= 0 && (t.scrollLeft = i = 0,
            t.dispatchEvent(r("ps-x-reach-start")));
            var n = a.get(t);
            "top" === e && i >= n.contentHeight - n.containerHeight && ((i = n.contentHeight - n.containerHeight) - t.scrollTop <= 1 ? i = t.scrollTop : t.scrollTop = i,
            t.dispatchEvent(r("ps-y-reach-end"))),
            "left" === e && i >= n.contentWidth - n.containerWidth && ((i = n.contentWidth - n.containerWidth) - t.scrollLeft <= 1 ? i = t.scrollLeft : t.scrollLeft = i,
            t.dispatchEvent(r("ps-x-reach-end"))),
            o = o || t.scrollTop,
            s = s || t.scrollLeft,
            "top" === e && i < o && t.dispatchEvent(r("ps-scroll-up")),
            "top" === e && o < i && t.dispatchEvent(r("ps-scroll-down")),
            "left" === e && i < s && t.dispatchEvent(r("ps-scroll-left")),
            "left" === e && s < i && t.dispatchEvent(r("ps-scroll-right")),
            "top" === e && (t.scrollTop = o = i,
            t.dispatchEvent(r("ps-scroll-y"))),
            "left" === e && (t.scrollLeft = s = i,
            t.dispatchEvent(r("ps-scroll-x")))
        }
    }
    , {
        "./instances": 18
...
var scrolltotop = {
    ...
    init: function() {
        jQuery(document).ready(function(t) {
            ...
            e.$body = window.opera ? "CSS1Compat" == document.compatMode ? t("html") : t("body") : t("html,body"),
...
function(e) {
    e.fn.downCount = function(t, c) {
        ...
        h.date || e.error("Date is not defined."),
        Date.parse(h.date) || e.error("Incorrect date format, it should look like this, 12/24/2012 12:00:00.");
        var u = this
          , d = function() {
            var t = new Date
        ...
        var f = setInterval(function() {
            ...
            var e = Math.floor(t / 864e5)
              ...
              , o = 1 === (e = 2 <= String(e).length ? e : "0" + e) ? "day" : "Days"
              , s = 1 === (i = 2 <= String(i).length ? i : "0" + i) ? "hour" : "Hours"
              , a = 1 === (n = 2 <= String(n).length ? n : "0" + n) ? "minute" : "Minutes"
              , l = 1 === (r = 2 <= String(r).length ? r : "0" + r) ? "second" : "Seconds";
            u.find(".days").text(e),
            u.find(".hours").text(i),
            u.find(".minutes").text(n),
            u.find(".seconds").text(r),
            u.find(".days_ref").text(o),
            u.find(".hours_ref").text(s),
            u.find(".minutes_ref").text(a),
            u.find(".seconds_ref").text(l)
        }, 1e3)
    }
}(jQuery),
function(n, r, e) {
    ...
    s.prototype.scrolly = function() {
        ...
        this.offsetTop >= t + e ? this.$element.addClass("scrolly-invisible") : i = this.$element.hasClass("scrolly-invisible") ? this.startPosition + (t + (e - this.offsetTop)) * this.velocity : this.startPosition + t * this.velocity,
        this.bgStart && (i += this.bgStart),
        !0 === this.options.bgParallax ? this.$element.css({
            backgroundPosition: "50% " + i + "px"
        }) : this.$element.css({
            top: i
        })
    }
    ...
    n.fn[i] = function(t) {
        return this.each(function() {
            n.data(this, "plugin_" + i) || n.data(this, "plugin_" + i, new s(this,t))
        })
    }
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            ...
            l.waypoint(function() {
                ...
                i = i.replace(/,/g, "");
                /^[0-9]+$/.test(i);
                for (var r = /^[0-9]+\.[0-9]+$/.test(i), o = r ? (i.split(".")[1] || []).length : 0, s = e; 1 <= s; s--) {
                    var a = parseInt(i / e * s);
                    if (r && (a = parseFloat(i / e * s).toFixed(o)),
                    n)
...
function() {
    ...
    e = this,
    i = function(l, o) {
        var e, s, a, c, i, h, u, r, d, n, f, p, g, m, v, w;
        function t(t) {
            var e = this;
            this.$element = t,
            this.element = t[0],
            ...
            t.bind(p, function() {
                ...
                if (!e.didScroll && !r)
                    ...
                    ,
                    o.setTimeout(t, l[w].settings.scrollThrottle)
            }),
            t.bind(f, function() {
                var t;
                if (!e.didResize)
                    ...
                    ,
                    o.setTimeout(t, l[w].settings.resizeThrottle)
            })
        }
        function y(t, e, i) {
            var n, r;
            ...
            (n = null != (r = t.data(m)) ? r : []).push(this.id),
            t.data(m, n)
        }
        return e = l(o),
        r = 0 <= _.call(o, "ontouchstart"),
        c = {
            horizontal: {},
            vertical: {}
        },
        ...
        t.prototype.doScroll = function() {
            ...
            !r || t.vertical.oldScroll && t.vertical.newScroll || l[w]("refresh"),
            l.each(t, function(t, r) {
                var i, e, o;
                return o = [],
                e = r.newScroll > r.oldScroll,
                i = e ? r.forward : r.backward,
        ...
        t.prototype.refresh = function() {
            ...
            t = {
                ...
                vertical: {
                    ...
                    contextDimension: i ? l[w]("viewportHeight") : this.$element.height(),
                    oldScroll: this.oldScroll.y,
                    forward: "down",
                    backward: "up",
                    offsetProp: "top"
            ...
            l.each(t, function(t, a) {
                return l.each(n.waypoints[t], function(t, e) {
                    ...
                    (!e.options.onlyOnScroll || null == r) && e.enabled)
                        return null !== r && r < (o = a.oldScroll) && o <= e.offset ? e.trigger([a.backward]) : null !== r && r > (s = a.oldScroll) && s >= e.offset ? e.trigger([a.forward]) : null === r && a.oldScroll >= e.offset ? e.trigger([a.forward]) : void 0
                })
            })
        }
        ,
        t.prototype.checkEmpty = function() {
            if (l.isEmptyObject(this.waypoints.horizontal) && l.isEmptyObject(this.waypoints.vertical))
                return this.$element.unbind([f, p].join(" ")),
                delete u[this.id]
        }
        ,
        s = t,
        ...
        n = {
            init: function(t, r) {
                return null == r && (r = {}),
                null == r.handler && (r.handler = t),
                this.each(function() {
                    var t, e, i, n;
                    return t = l(this),
                    i = null != (n = r.context) ? n : l.fn[v].defaults.context,
                    l.isWindow(i) || (i = t.closest(i)),
                    i = l(i),
                    e = (e = u[i.data(h)]) || new s(i),
                    new a(t,e,r)
                }),
                l[w]("refresh"),
                this
        ...
        l.fn[v] = function() {
            ...
            n[e] ? n[e].apply(this, t) : l.isFunction(e) ? n.init.apply(this, arguments) : l.isPlainObject(e) ? n.init.apply(this, [null, e]) : e ? l.error("The " + e + " method does not exist in jQuery Waypoints.") : l.error("jQuery Waypoints needs a callback function or handler option.")
        }
        ,
        l.fn[v].defaults = {
            context: o,
        ...
        d = {
            ...
            aggregate: function(t) {
                var e, n, i;
                return e = c,
                t && (e = null != (i = u[l(t).data(h)]) ? i.waypoints : void 0),
                e ? (n = {
                    horizontal: [],
                    vertical: []
                },
        ...
        l[w] = function() {
            ...
            return e = arguments[0],
            t = 2 <= arguments.length ? b.call(arguments, 1) : [],
            d[e] ? d[e].apply(null, t) : d.aggregate.call(null, e)
        }
        ,
        l[w].settings = {
            resizeThrottle: 100,
